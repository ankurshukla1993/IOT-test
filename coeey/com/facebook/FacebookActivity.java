...
public class FacebookActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C1100R.layout.com_facebook_activity_layout);
        ...
        if (fragment == null) {
            if (FacebookDialogFragment.TAG.equals(intent.getAction())) {
                ...
                manager.beginTransaction().add(C1100R.id.com_facebook_fragment_container, fragment, FRAGMENT_TAG).commit();
            }
        }
