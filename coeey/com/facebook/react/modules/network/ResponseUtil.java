...
public class ResponseUtil {
    public static void onDataSend(RCTDeviceEventEmitter eventEmitter, int requestId, long progress, long total) {
    ...
    public static void onIncrementalDataReceived(RCTDeviceEventEmitter eventEmitter, int requestId, String data, long progress, long total) {
        WritableArray args = Arguments.createArray();
        args.pushInt(requestId);
    ...
    public static void onDataReceivedProgress(RCTDeviceEventEmitter eventEmitter, int requestId, long progress, long total) {
        WritableArray args = Arguments.createArray();
        args.pushInt(requestId);
        args.pushInt((int) progress);
        args.pushInt((int) total);
    ...
    public static void onRequestError(RCTDeviceEventEmitter eventEmitter, int requestId, String error, IOException e) {
        WritableArray args = Arguments.createArray();
        args.pushInt(requestId);
    ...
    public static void onResponseReceived(RCTDeviceEventEmitter eventEmitter, int requestId, int statusCode, WritableMap headers, String url) {
        WritableArray args = Arguments.createArray();
        args.pushInt(requestId);
