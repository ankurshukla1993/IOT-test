...
public class ReactMarkerConstants {
    ...
    public static final String CORE_REACT_PACKAGE_GET_REACT_MODULE_INFO_PROVIDER_END = "CORE_REACT_PACKAGE_GET_REACT_MODULE_INFO_PROVIDER_END";
    public static final String CORE_REACT_PACKAGE_GET_REACT_MODULE_INFO_PROVIDER_START = "CORE_REACT_PACKAGE_GET_REACT_MODULE_INFO_PROVIDER_START";
    ...
    public static final String CREATE_I18N_MODULE_CONSTANTS_END = "CREATE_I18N_MODULE_CONSTANTS_END";
    public static final String CREATE_I18N_MODULE_CONSTANTS_START = "CREATE_I18N_MODULE_CONSTANTS_START";
    ...
    public static final String I18N_MODULE_CONSTANTS_CONVERT_END = "I18N_MODULE_CONSTANTS_CONVERT_END";
    public static final String I18N_MODULE_CONSTANTS_CONVERT_START = "I18N_MODULE_CONSTANTS_CONVERT_START";
    ...
    public static final String UI_MANAGER_MODULE_CONSTANTS_CONVERT_END = "UI_MANAGER_MODULE_CONSTANTS_CONVERT_END";
    public static final String UI_MANAGER_MODULE_CONSTANTS_CONVERT_START = "UI_MANAGER_MODULE_CONSTANTS_CONVERT_START";
}
