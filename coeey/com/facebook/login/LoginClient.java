...
class LoginClient implements Parcelable {
    public static final Creator<LoginClient> CREATOR = new C12451();
    ...
    static class C12451 implements Creator {
        C12451() {
        }
    ...
    public static class Request implements Parcelable {
        public static final Creator<Request> CREATOR = new C12461();
        ...
        static class C12461 implements Creator {
            C12461() {
            }
    ...
    public static class Result implements Parcelable {
        public static final Creator<Result> CREATOR = new C12471();
        final Code code;
        ...
        static class C12471 implements Creator {
            C12471() {
            }
    ...
    boolean checkInternetPermission() {
        ...
        if (checkPermission("android.permission.INTERNET") != 0) {
            ...
            complete(Result.createErrorResult(this.pendingRequest, activity.getString(C1100R.string.com_facebook_internet_permission_error_title), activity.getString(C1100R.string.com_facebook_internet_permission_error_message)));
            return false;
        }
