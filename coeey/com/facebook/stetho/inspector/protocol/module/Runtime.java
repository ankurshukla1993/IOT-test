...
public class Runtime implements ChromeDevtoolsDomain {
    ...
    private static class Session {
        ...
        private GetPropertiesResponse getPropertiesForProtoContainer(ObjectProtoContainer proto) {
            ...
            descriptor.name = AppEventsConstants.EVENT_PARAM_VALUE_YES;
    ...
    @Nonnull
    private static synchronized Session getSession(JsonRpcPeer peer) {
        Session session;
        synchronized (Runtime.class) {
            ...
            if (session == null) {
                ...
                peer.registerDisconnectReceiver(new 2(peer));
            }
        }
        return session;
    }
