...
public class Page implements ChromeDevtoolsDomain {
    ...
    private void notifyExecutionContexts(JsonRpcPeer peer) {
        ...
        context.frameId = AppEventsConstants.EVENT_PARAM_VALUE_YES;
        context.id = 1;
    ...
    public JsonRpcResult getResourceTree(JsonRpcPeer peer, JSONObject params) {
        ...
        FrameResourceTree tree = createSimpleFrameResourceTree(AppEventsConstants.EVENT_PARAM_VALUE_YES, null, "Stetho", prefsTagsIter.hasNext() ? (String) prefsTagsIter.next() : "");
        ...
        while (prefsTagsIter.hasNext()) {
            ...
            tree.childFrames.add(createSimpleFrameResourceTree(frameId, AppEventsConstants.EVENT_PARAM_VALUE_YES, "Child #" + frameId, (String) prefsTagsIter.next()));
