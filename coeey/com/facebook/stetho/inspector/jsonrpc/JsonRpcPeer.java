...
public class JsonRpcPeer {
    ...
    public void invokeMethod(String method, Object paramsObject, @Nullable PendingRequestCallback callback) throws NotYetConnectedException {
        ...
        this.mPeer.sendText(((JSONObject) this.mObjectMapper.convertValue(new JsonRpcRequest(callback != null ? Long.valueOf(preparePendingRequest(callback)) : null, method, (JSONObject) this.mObjectMapper.convertValue(paramsObject, JSONObject.class)), JSONObject.class)).toString());
    }
