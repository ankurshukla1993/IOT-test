...
public class DOMStoragePeerManager extends ChromePeerManager {
    ...
    private final PeerRegistrationListener mPeerListener = new C14381();

    class C14381 extends PeersRegisteredListener {
    ...
    private class DevToolsSharedPreferencesListener implements OnSharedPreferenceChangeListener {
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            ...
            if (existedBefore && existsNow) {
                ...
                LogUtil.m194i("Detected rapid put/remove of %s", key);
            }
        }
    }
