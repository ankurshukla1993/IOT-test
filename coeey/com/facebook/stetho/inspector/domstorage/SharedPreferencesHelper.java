...
public class SharedPreferencesHelper {
    ...
    private static Boolean parseBoolean(String s) throws IllegalArgumentException {
        if (AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(s) || ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equalsIgnoreCase(s)) {
            return Boolean.TRUE;
        }
        if (AppEventsConstants.EVENT_PARAM_VALUE_NO.equals(s) || "false".equalsIgnoreCase(s)) {
