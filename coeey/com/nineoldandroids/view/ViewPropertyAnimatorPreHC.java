...
class ViewPropertyAnimatorPreHC extends ViewPropertyAnimator {
    ...
    private static final int f2466X = 128;
    private static final int f2467Y = 256;
    private Runnable mAnimationStarter = new C22831();
    ...
    class C22831 implements Runnable {
        C22831() {
        }
    ...
    public ViewPropertyAnimator mo5672x(float value) {
    ...
    public ViewPropertyAnimator mo5674y(float value) {
    ...
    private void startAnimation() {
        ValueAnimator animator = ValueAnimator.ofFloat(FlexItem.FLEX_SHRINK_DEFAULT);
