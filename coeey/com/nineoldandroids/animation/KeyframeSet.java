...
class KeyframeSet {
    ...
    public static KeyframeSet ofInt(int... values) {
        ...
        if (numKeyframes == 1) {
            ...
            keyframes[1] = (IntKeyframe) Keyframe.ofInt(FlexItem.FLEX_SHRINK_DEFAULT, values[0]);
        } else {
    ...
    public static KeyframeSet ofFloat(float... values) {
        ...
        if (numKeyframes == 1) {
            ...
            keyframes[1] = (FloatKeyframe) Keyframe.ofFloat(FlexItem.FLEX_SHRINK_DEFAULT, values[0]);
        } else {
    ...
    public static KeyframeSet ofObject(Object... values) {
        ...
        if (numKeyframes == 1) {
            ...
            keyframes[1] = (ObjectKeyframe) Keyframe.ofObject(FlexItem.FLEX_SHRINK_DEFAULT, values[0]);
        } else {
    ...
    public Object getValue(float fraction) {
        ...
        } else if (fraction >= FlexItem.FLEX_SHRINK_DEFAULT) {
    ...
    public String toString() {
        String returnVal = Constants.SPACE;
