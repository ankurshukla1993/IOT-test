...
public class ValueAnimator extends Animator {
    ...
    private static final ThreadLocal<ArrayList<ValueAnimator>> sAnimations = new C22761();
    private static final Interpolator sDefaultInterpolator = new AccelerateDecelerateInterpolator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sDelayedAnims = new C22783();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sEndingAnims = new C22794();
    private static final TypeEvaluator sFloatEvaluator = new FloatEvaluator();
    private static long sFrameDelay = DEFAULT_FRAME_DELAY;
    private static final TypeEvaluator sIntEvaluator = new IntEvaluator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sPendingAnimations = new C22772();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sReadyAnims = new C22805();
    ...
    static class C22761 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C22761() {
        }
    ...
    static class C22772 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C22772() {
        }
    ...
    static class C22783 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C22783() {
        }
    ...
    static class C22794 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C22794() {
        }
    ...
    static class C22805 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C22805() {
        }
    ...
    public void end() {
        ...
        if (this.mRepeatCount <= 0 || (this.mRepeatCount & 1) != 1) {
            animateValue(FlexItem.FLEX_SHRINK_DEFAULT);
        } else {
            animateValue(0.0f);
        }
        endAnimation();
    ...
    boolean animationFrame(long currentTime) {
        ...
        switch (this.mPlayingState) {
            case 1:
            case 2:
                float fraction = this.mDuration > 0 ? ((float) (currentTime - this.mStartTime)) / ((float) this.mDuration) : FlexItem.FLEX_SHRINK_DEFAULT;
                if (fraction >= FlexItem.FLEX_SHRINK_DEFAULT) {
                    if (this.mCurrentIteration < this.mRepeatCount || this.mRepeatCount == -1) {
                        ...
                        fraction %= FlexItem.FLEX_SHRINK_DEFAULT;
                        this.mStartTime += this.mDuration;
                    } else {
                        done = true;
                        fraction = Math.min(fraction, FlexItem.FLEX_SHRINK_DEFAULT);
                    }
                }
                if (this.mPlayingBackwards) {
                    fraction = FlexItem.FLEX_SHRINK_DEFAULT - fraction;
                }
