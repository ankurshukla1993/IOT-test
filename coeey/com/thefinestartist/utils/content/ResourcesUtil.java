...
public class ResourcesUtil {
    ...
    @ColorInt
    public static int getColor(@ColorRes int colorRes, Theme theme) {
    ...
    public static ColorStateList getColorStateList(@ColorRes int colorRes, Theme theme) {
        if (APILevel.require(23)) {
    ...
    public static Drawable getDrawable(@DrawableRes int drawableRes, Theme theme) {
    ...
    public static String getQuantityString(@PluralsRes int pluralsRes, int quantity) throws NotFoundException {
