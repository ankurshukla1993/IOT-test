...
public class TemperatureAlertMessage {
    ...
    @SerializedName("temperatureAlertValue")
    private String temperatureAlertValue = null;
    ...
    public TemperatureAlertMessage id(String id) {
        this.id = id;
        return this;
    }
    ...
    public TemperatureAlertMessage payloadSize(Integer payloadSize) {
    ...
    public TemperatureAlertMessage commandId(CommandIdEnum commandId) {
    ...
    public TemperatureAlertMessage commandExtension(CommandExtensionEnum commandExtension) {
    ...
    public TemperatureAlertMessage fullMessage(String fullMessage) {
    ...
    public TemperatureAlertMessage deviceId(String deviceId) {
    ...
    public TemperatureAlertMessage createdOn(DateTime createdOn) {
    ...
    public TemperatureAlertMessage timestamp(Long timestamp) {
    ...
    public TemperatureAlertMessage latitude(Double latitude) {
    ...
    public TemperatureAlertMessage longitude(Double longitude) {
    ...
    public TemperatureAlertMessage heading(String heading) {
    ...
    public TemperatureAlertMessage altitude(String altitude) {
    ...
    public TemperatureAlertMessage assistedGPS(String assistedGPS) {
    ...
    public TemperatureAlertMessage gpsSpeed(String gpsSpeed) {
    ...
    public TemperatureAlertMessage horizontalUncertainity(String horizontalUncertainity) {
    ...
    public TemperatureAlertMessage perpendicularUncertainity(String perpendicularUncertainity) {
    ...
    public TemperatureAlertMessage horizontalUncertainityAngle(String horizontalUncertainityAngle) {
    ...
    public TemperatureAlertMessage altitudeUncertainity(String altitudeUncertainity) {
    ...
    public TemperatureAlertMessage batteryStatus(String batteryStatus) {
    ...
    public TemperatureAlertMessage temperature(String temperature) {
    ...
    public TemperatureAlertMessage steps(String steps) {
        this.steps = steps;
        return this;
    }
    ...
    public TemperatureAlertMessage temperatureAlertValue(String temperatureAlertValue) {
        this.temperatureAlertValue = temperatureAlertValue;
        return this;
    }

    @ApiModelProperty("")
    public String getTemperatureAlertValue() {
        return this.temperatureAlertValue;
    }

    public void setTemperatureAlertValue(String temperatureAlertValue) {
        this.temperatureAlertValue = temperatureAlertValue;
    }

    public TemperatureAlertMessage command(CommandEnum command) {
    ...
    public boolean equals(Object o) {
        ...
        TemperatureAlertMessage temperatureAlertMessage = (TemperatureAlertMessage) o;
        if (Objects.equals(this.id, temperatureAlertMessage.id) && Objects.equals(this.payloadSize, temperatureAlertMessage.payloadSize) && Objects.equals(this.commandId, temperatureAlertMessage.commandId) && Objects.equals(this.commandExtension, temperatureAlertMessage.commandExtension) && Objects.equals(this.fullMessage, temperatureAlertMessage.fullMessage) && Objects.equals(this.deviceId, temperatureAlertMessage.deviceId) && Objects.equals(this.createdOn, temperatureAlertMessage.createdOn) && Objects.equals(this.timestamp, temperatureAlertMessage.timestamp) && Objects.equals(this.latitude, temperatureAlertMessage.latitude) && Objects.equals(this.longitude, temperatureAlertMessage.longitude) && Objects.equals(this.heading, temperatureAlertMessage.heading) && Objects.equals(this.altitude, temperatureAlertMessage.altitude) && Objects.equals(this.assistedGPS, temperatureAlertMessage.assistedGPS) && Objects.equals(this.gpsSpeed, temperatureAlertMessage.gpsSpeed) && Objects.equals(this.horizontalUncertainity, temperatureAlertMessage.horizontalUncertainity) && Objects.equals(this.perpendicularUncertainity, temperatureAlertMessage.perpendicularUncertainity) && Objects.equals(this.horizontalUncertainityAngle, temperatureAlertMessage.horizontalUncertainityAngle) && Objects.equals(this.altitudeUncertainity, temperatureAlertMessage.altitudeUncertainity) && Objects.equals(this.batteryStatus, temperatureAlertMessage.batteryStatus) && Objects.equals(this.temperature, temperatureAlertMessage.temperature) && Objects.equals(this.steps, temperatureAlertMessage.steps) && Objects.equals(this.temperatureAlertValue, temperatureAlertMessage.temperatureAlertValue) && Objects.equals(this.command, temperatureAlertMessage.command)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        sb.append("    temperatureAlertValue: ").append(toIndentedString(this.temperatureAlertValue)).append("\n");
