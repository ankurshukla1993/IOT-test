...
public class EmergencyAlertMessage {
    ...
    public EmergencyAlertMessage id(String id) {
        this.id = id;
        return this;
    }
    ...
    public EmergencyAlertMessage payloadSize(Integer payloadSize) {
    ...
    public EmergencyAlertMessage commandId(CommandIdEnum commandId) {
    ...
    public EmergencyAlertMessage commandExtension(CommandExtensionEnum commandExtension) {
    ...
    public EmergencyAlertMessage fullMessage(String fullMessage) {
    ...
    public EmergencyAlertMessage deviceId(String deviceId) {
    ...
    public EmergencyAlertMessage createdOn(DateTime createdOn) {
    ...
    public EmergencyAlertMessage timestamp(Long timestamp) {
    ...
    public EmergencyAlertMessage latitude(Double latitude) {
    ...
    public EmergencyAlertMessage longitude(Double longitude) {
    ...
    public EmergencyAlertMessage heading(String heading) {
    ...
    public EmergencyAlertMessage altitude(String altitude) {
    ...
    public EmergencyAlertMessage assistedGPS(String assistedGPS) {
    ...
    public EmergencyAlertMessage gpsSpeed(String gpsSpeed) {
    ...
    public EmergencyAlertMessage horizontalUncertainity(String horizontalUncertainity) {
    ...
    public EmergencyAlertMessage perpendicularUncertainity(String perpendicularUncertainity) {
    ...
    public EmergencyAlertMessage horizontalUncertainityAngle(String horizontalUncertainityAngle) {
    ...
    public EmergencyAlertMessage altitudeUncertainity(String altitudeUncertainity) {
    ...
    public EmergencyAlertMessage batteryStatus(String batteryStatus) {
    ...
    public EmergencyAlertMessage temperature(String temperature) {
    ...
    public EmergencyAlertMessage command(CommandEnum command) {
    ...
    public boolean equals(Object o) {
        ...
        EmergencyAlertMessage emergencyAlertMessage = (EmergencyAlertMessage) o;
        if (Objects.equals(this.id, emergencyAlertMessage.id) && Objects.equals(this.payloadSize, emergencyAlertMessage.payloadSize) && Objects.equals(this.commandId, emergencyAlertMessage.commandId) && Objects.equals(this.commandExtension, emergencyAlertMessage.commandExtension) && Objects.equals(this.fullMessage, emergencyAlertMessage.fullMessage) && Objects.equals(this.deviceId, emergencyAlertMessage.deviceId) && Objects.equals(this.createdOn, emergencyAlertMessage.createdOn) && Objects.equals(this.timestamp, emergencyAlertMessage.timestamp) && Objects.equals(this.latitude, emergencyAlertMessage.latitude) && Objects.equals(this.longitude, emergencyAlertMessage.longitude) && Objects.equals(this.heading, emergencyAlertMessage.heading) && Objects.equals(this.altitude, emergencyAlertMessage.altitude) && Objects.equals(this.assistedGPS, emergencyAlertMessage.assistedGPS) && Objects.equals(this.gpsSpeed, emergencyAlertMessage.gpsSpeed) && Objects.equals(this.horizontalUncertainity, emergencyAlertMessage.horizontalUncertainity) && Objects.equals(this.perpendicularUncertainity, emergencyAlertMessage.perpendicularUncertainity) && Objects.equals(this.horizontalUncertainityAngle, emergencyAlertMessage.horizontalUncertainityAngle) && Objects.equals(this.altitudeUncertainity, emergencyAlertMessage.altitudeUncertainity) && Objects.equals(this.batteryStatus, emergencyAlertMessage.batteryStatus) && Objects.equals(this.temperature, emergencyAlertMessage.temperature) && Objects.equals(this.command, emergencyAlertMessage.command)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        sb.append("class EmergencyAlertMessage {\n");
