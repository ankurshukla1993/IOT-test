...
public class TrackingAlertMessage {
    ...
    public TrackingAlertMessage id(String id) {
        this.id = id;
        return this;
    }
    ...
    public TrackingAlertMessage payloadSize(Integer payloadSize) {
    ...
    public TrackingAlertMessage commandId(CommandIdEnum commandId) {
    ...
    public TrackingAlertMessage commandExtension(CommandExtensionEnum commandExtension) {
    ...
    public TrackingAlertMessage fullMessage(String fullMessage) {
    ...
    public TrackingAlertMessage deviceId(String deviceId) {
    ...
    public TrackingAlertMessage createdOn(DateTime createdOn) {
    ...
    public TrackingAlertMessage timestamp(Long timestamp) {
    ...
    public TrackingAlertMessage latitude(Double latitude) {
    ...
    public TrackingAlertMessage longitude(Double longitude) {
    ...
    public TrackingAlertMessage heading(String heading) {
    ...
    public TrackingAlertMessage altitude(String altitude) {
    ...
    public TrackingAlertMessage assistedGPS(String assistedGPS) {
    ...
    public TrackingAlertMessage gpsSpeed(String gpsSpeed) {
    ...
    public TrackingAlertMessage horizontalUncertainity(String horizontalUncertainity) {
    ...
    public TrackingAlertMessage perpendicularUncertainity(String perpendicularUncertainity) {
    ...
    public TrackingAlertMessage horizontalUncertainityAngle(String horizontalUncertainityAngle) {
    ...
    public TrackingAlertMessage altitudeUncertainity(String altitudeUncertainity) {
    ...
    public TrackingAlertMessage batteryStatus(String batteryStatus) {
    ...
    public TrackingAlertMessage temperature(String temperature) {
    ...
    public TrackingAlertMessage steps(String steps) {
        this.steps = steps;
        return this;
    }
    ...
    public TrackingAlertMessage command(CommandEnum command) {
    ...
    public boolean equals(Object o) {
        ...
        TrackingAlertMessage trackingAlertMessage = (TrackingAlertMessage) o;
        if (Objects.equals(this.id, trackingAlertMessage.id) && Objects.equals(this.payloadSize, trackingAlertMessage.payloadSize) && Objects.equals(this.commandId, trackingAlertMessage.commandId) && Objects.equals(this.commandExtension, trackingAlertMessage.commandExtension) && Objects.equals(this.fullMessage, trackingAlertMessage.fullMessage) && Objects.equals(this.deviceId, trackingAlertMessage.deviceId) && Objects.equals(this.createdOn, trackingAlertMessage.createdOn) && Objects.equals(this.timestamp, trackingAlertMessage.timestamp) && Objects.equals(this.latitude, trackingAlertMessage.latitude) && Objects.equals(this.longitude, trackingAlertMessage.longitude) && Objects.equals(this.heading, trackingAlertMessage.heading) && Objects.equals(this.altitude, trackingAlertMessage.altitude) && Objects.equals(this.assistedGPS, trackingAlertMessage.assistedGPS) && Objects.equals(this.gpsSpeed, trackingAlertMessage.gpsSpeed) && Objects.equals(this.horizontalUncertainity, trackingAlertMessage.horizontalUncertainity) && Objects.equals(this.perpendicularUncertainity, trackingAlertMessage.perpendicularUncertainity) && Objects.equals(this.horizontalUncertainityAngle, trackingAlertMessage.horizontalUncertainityAngle) && Objects.equals(this.altitudeUncertainity, trackingAlertMessage.altitudeUncertainity) && Objects.equals(this.batteryStatus, trackingAlertMessage.batteryStatus) && Objects.equals(this.temperature, trackingAlertMessage.temperature) && Objects.equals(this.steps, trackingAlertMessage.steps) && Objects.equals(this.command, trackingAlertMessage.command)) {
            return true;
        }
        return false;
    }
