...
public class GeofencingAlertMessage {
    ...
    @SerializedName("geoFenceNumber")
    private String geoFenceNumber = null;
    @SerializedName("geoFenceOutside")
    private String geoFenceOutside = null;
    ...
    public GeofencingAlertMessage id(String id) {
        this.id = id;
        return this;
    }
    ...
    public GeofencingAlertMessage payloadSize(Integer payloadSize) {
    ...
    public GeofencingAlertMessage commandId(CommandIdEnum commandId) {
    ...
    public GeofencingAlertMessage commandExtension(CommandExtensionEnum commandExtension) {
    ...
    public GeofencingAlertMessage fullMessage(String fullMessage) {
    ...
    public GeofencingAlertMessage deviceId(String deviceId) {
    ...
    public GeofencingAlertMessage createdOn(DateTime createdOn) {
    ...
    public GeofencingAlertMessage timestamp(Long timestamp) {
    ...
    public GeofencingAlertMessage latitude(Double latitude) {
    ...
    public GeofencingAlertMessage longitude(Double longitude) {
    ...
    public GeofencingAlertMessage heading(String heading) {
    ...
    public GeofencingAlertMessage altitude(String altitude) {
    ...
    public GeofencingAlertMessage assistedGPS(String assistedGPS) {
    ...
    public GeofencingAlertMessage gpsSpeed(String gpsSpeed) {
    ...
    public GeofencingAlertMessage horizontalUncertainity(String horizontalUncertainity) {
    ...
    public GeofencingAlertMessage perpendicularUncertainity(String perpendicularUncertainity) {
    ...
    public GeofencingAlertMessage horizontalUncertainityAngle(String horizontalUncertainityAngle) {
    ...
    public GeofencingAlertMessage altitudeUncertainity(String altitudeUncertainity) {
    ...
    public GeofencingAlertMessage batteryStatus(String batteryStatus) {
    ...
    public GeofencingAlertMessage temperature(String temperature) {
    ...
    public GeofencingAlertMessage geoFenceNumber(String geoFenceNumber) {
    ...
    public GeofencingAlertMessage geoFenceOutside(String geoFenceOutside) {
        this.geoFenceOutside = geoFenceOutside;
        return this;
    }

    @ApiModelProperty("")
    public String getGeoFenceOutside() {
        return this.geoFenceOutside;
    }

    public void setGeoFenceOutside(String geoFenceOutside) {
        this.geoFenceOutside = geoFenceOutside;
    }

    public GeofencingAlertMessage command(CommandEnum command) {
    ...
    public boolean equals(Object o) {
        ...
        GeofencingAlertMessage geofencingAlertMessage = (GeofencingAlertMessage) o;
        if (Objects.equals(this.id, geofencingAlertMessage.id) && Objects.equals(this.payloadSize, geofencingAlertMessage.payloadSize) && Objects.equals(this.commandId, geofencingAlertMessage.commandId) && Objects.equals(this.commandExtension, geofencingAlertMessage.commandExtension) && Objects.equals(this.fullMessage, geofencingAlertMessage.fullMessage) && Objects.equals(this.deviceId, geofencingAlertMessage.deviceId) && Objects.equals(this.createdOn, geofencingAlertMessage.createdOn) && Objects.equals(this.timestamp, geofencingAlertMessage.timestamp) && Objects.equals(this.latitude, geofencingAlertMessage.latitude) && Objects.equals(this.longitude, geofencingAlertMessage.longitude) && Objects.equals(this.heading, geofencingAlertMessage.heading) && Objects.equals(this.altitude, geofencingAlertMessage.altitude) && Objects.equals(this.assistedGPS, geofencingAlertMessage.assistedGPS) && Objects.equals(this.gpsSpeed, geofencingAlertMessage.gpsSpeed) && Objects.equals(this.horizontalUncertainity, geofencingAlertMessage.horizontalUncertainity) && Objects.equals(this.perpendicularUncertainity, geofencingAlertMessage.perpendicularUncertainity) && Objects.equals(this.horizontalUncertainityAngle, geofencingAlertMessage.horizontalUncertainityAngle) && Objects.equals(this.altitudeUncertainity, geofencingAlertMessage.altitudeUncertainity) && Objects.equals(this.batteryStatus, geofencingAlertMessage.batteryStatus) && Objects.equals(this.temperature, geofencingAlertMessage.temperature) && Objects.equals(this.geoFenceNumber, geofencingAlertMessage.geoFenceNumber) && Objects.equals(this.geoFenceOutside, geofencingAlertMessage.geoFenceOutside) && Objects.equals(this.command, geofencingAlertMessage.command)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        sb.append("    geoFenceNumber: ").append(toIndentedString(this.geoFenceNumber)).append("\n");
        sb.append("    geoFenceOutside: ").append(toIndentedString(this.geoFenceOutside)).append("\n");
