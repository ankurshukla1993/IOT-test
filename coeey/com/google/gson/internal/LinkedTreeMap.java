...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C19311();
    ...
    static class C19311 implements Comparator<Comparable> {
        C19311() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C19321 extends LinkedTreeMapIterator<Entry<K, V>> {
            C19321() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C19331 extends LinkedTreeMapIterator<K> {
            C19331() {
                super();
            }
