...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C19281();
    ...
    static class C19281 implements Comparator<Comparable> {
        C19281() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C19291 extends LinkedTreeMapIterator<Entry<K, V>> {
            C19291() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C19301 extends LinkedTreeMapIterator<K> {
            C19301() {
                super();
            }
