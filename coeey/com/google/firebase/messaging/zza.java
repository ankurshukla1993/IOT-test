...
final class zza {
    ...
    private final Notification zza(CharSequence charSequence, String str, int i, Integer num, Uri uri, PendingIntent pendingIntent, PendingIntent pendingIntent2, String str2) {
        ...
        if (str2 != null) {
            ...
            if (this.zznvi == null) {
                ...
                try {
                    this.zznvi.invoke(smallIcon, new Object[]{str2});
                } catch (Throwable e) {
    ...
    static String zzaj(Bundle bundle) {
    ...
    static synchronized zza zzex(Context context) {
        ...
        synchronized (zza.class) {
            ...
            com_google_firebase_messaging_zza = zznvh;
        }
    ...
    private final String zzrd(String str) {
        ...
        try {
            if (this.zznvj == null) {
                this.zznvj = notificationManager.getClass().getMethod("getNotificationChannel", new Class[]{String.class});
            }
            if (!TextUtils.isEmpty(str)) {
                if (this.zznvj.invoke(notificationManager, new Object[]{str}) != null) {
                    return str;
                }
            ...
            Object string = zzaui().getString("com.google.firebase.messaging.default_notification_channel_id");
            if (TextUtils.isEmpty(string)) {
                Log.w("FirebaseMessaging", "Missing Default Notification Channel metadata in AndroidManifest. Default value will be used.");
            } else {
                if (this.zznvj.invoke(notificationManager, new Object[]{string}) != null) {
                    return string;
                }
                Log.w("FirebaseMessaging", "Notification Channel set in AndroidManifest.xml has not been created by the app. Default value will be used.");
            }
            if (this.zznvj.invoke(notificationManager, new Object[]{"fcm_fallback_notification_channel"}) == null) {
    ...
    private final PendingIntent zzt(Bundle bundle) {
        ...
        return PendingIntent.getActivity(this.mContext, this.zznvk.incrementAndGet(), intent, Ints.MAX_POWER_OF_TWO);
    }
    ...
    final boolean zzs(Bundle bundle) {
        ...
        if (!((KeyguardManager) this.mContext.getSystemService("keyguard")).inKeyguardRestrictedInputMode()) {
            ...
            List<RunningAppProcessInfo> runningAppProcesses = ((ActivityManager) this.mContext.getSystemService(AmProfile.SYNC_ACTIVITY_DATA_AM)).getRunningAppProcesses();
                ...
                for (RunningAppProcessInfo runningAppProcessInfo : runningAppProcesses) {
                    if (runningAppProcessInfo.pid == myPid) {
                        ...
                        if (!TextUtils.isEmpty(zze)) {
                            ...
                            zzrc = zzrc(zze(bundle, "gcm.n.color"));
                            zze = zzaj(bundle);
                            if (TextUtils.isEmpty(zze)) {
                                uri = null;
                            ...
                            zzt = zzt(bundle);
                            if (FirebaseMessagingService.zzak(bundle)) {
                                pendingIntent = null;
                                parcelable = zzt;
                            } else {
                                ...
                                zza = zzaa.zza(this.mContext, this.zznvk.incrementAndGet(), intent, Ints.MAX_POWER_OF_TWO);
                                intent2 = new Intent("com.google.firebase.messaging.NOTIFICATION_DISMISS");
                                zza(intent2, bundle);
                                pendingIntent = zzaa.zza(this.mContext, this.zznvk.incrementAndGet(), intent2, Ints.MAX_POWER_OF_TWO);
                            }
                            if (zzq.isAtLeastO() || this.mContext.getApplicationInfo().targetSdkVersion <= 25) {
                                ...
                                if (zzrc != null) {
                                    smallIcon.setColor(zzrc.intValue());
                                }
                                if (uri != null) {
                                    smallIcon.setSound(uri);
                                }
                                ...
                                build = zza(zzj, zzj2, identifier, zzrc, uri, zza, pendingIntent, zzrd(zze(bundle, "gcm.n.android_channel_id")));
                            }
                        ...
                        i = zzaui().getInt("com.google.firebase.messaging.default_notification_icon", 0);
                        if (i == 0) {
