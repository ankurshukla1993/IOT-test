...
public final class zzf extends Binder {
    ...
    zzf(zzb com_google_firebase_iid_zzb) {
        this.zznto = com_google_firebase_iid_zzb;
    }
    ...
    public final void zza(zzd com_google_firebase_iid_zzd) {
        ...
        if (this.zznto.zzq(com_google_firebase_iid_zzd.intent)) {
        ...
        this.zznto.zzibs.execute(new zzg(this, com_google_firebase_iid_zzd));
    }
}
