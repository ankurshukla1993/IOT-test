...
final class zzfgp extends zzfgm {
    ...
    private static int zza(byte[] bArr, int i, long j, int i2) {
        switch (i2) {
            case 0:
                return zzfgl.zzlt(i);
            case 1:
                return zzfgl.zzaj(i, zzfgj.zzb(bArr, j));
            case 2:
                return zzfgl.zzi(i, zzfgj.zzb(bArr, j), zzfgj.zzb(bArr, 1 + j));
            default:
    ...
    L_0x000e:
        r2 = 1;
        r2 = r2 + r4;
        r1 = com.google.android.gms.internal.zzfgj.zzb(r9, r4);
    ...
    L_0x001f:
        r4 = 1;
        r4 = r4 + r2;
        r1 = com.google.android.gms.internal.zzfgj.zzb(r9, r2);
    ...
    L_0x005c:
        ...
        r2 = 1;
        r6 = r4 + r2;
        r2 = com.google.android.gms.internal.zzfgj.zzb(r9, r4);
        r3 = -65;
    ...
    L_0x007a:
        r2 = 1;
        r2 = r2 + r6;
        r1 = com.google.android.gms.internal.zzfgj.zzb(r9, r6);
        r4 = -65;
        if (r1 <= r4) goto L_0x000a;
    L_0x0085:
        r0 = -1;
    ...
    L_0x008f:
        ...
        r2 = 1;
        r2 = r2 + r4;
        r4 = com.google.android.gms.internal.zzfgj.zzb(r9, r4);
        r5 = -65;
    ...
    final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i3 < length) {
            ...
            if (charAt < '' && j3 < j2) {
                j = 1 + j3;
                zzfgj.zza(bArr, j3, (byte) charAt);
            } else if (charAt < 'ࠀ' && j3 <= j2 - 2) {
                r12 = j3 + 1;
                zzfgj.zza(bArr, j3, (byte) ((charAt >>> 6) | 960));
                j = 1 + r12;
                zzfgj.zza(bArr, r12, (byte) ((charAt & 63) | 128));
            } else if ((charAt < '?' || '?' < charAt) && j3 <= j2 - 3) {
                j = 1 + j3;
                zzfgj.zza(bArr, j3, (byte) ((charAt >>> 12) | 480));
                j3 = 1 + j;
                zzfgj.zza(bArr, j, (byte) (((charAt >>> 6) & 63) | 128));
                j = 1 + j3;
                zzfgj.zza(bArr, j3, (byte) ((charAt & 63) | 128));
            } else if (j3 <= j2 - 4) {
                if (i3 + 1 != length) {
                    i3++;
                    ...
                    if (Character.isSurrogatePair(charAt, charAt2)) {
                        ...
                        j = 1 + j3;
                        zzfgj.zza(bArr, j3, (byte) ((toCodePoint >>> 18) | 240));
                        j3 = 1 + j;
                        zzfgj.zza(bArr, j, (byte) (((toCodePoint >>> 12) & 63) | 128));
                        r12 = j3 + 1;
                        zzfgj.zza(bArr, j3, (byte) (((toCodePoint >>> 6) & 63) | 128));
                        j = 1 + r12;
                        zzfgj.zza(bArr, r12, (byte) ((toCodePoint & 63) | 128));
                    }
                }
                throw new zzfgo(i3 - 1, length);
