...
final class zzl<TResult> {
    ...
    public final void zza(@NonNull zzk<TResult> com_google_android_gms_tasks_zzk_TResult) {
        synchronized (this.mLock) {
            ...
            this.zzkrq.add(com_google_android_gms_tasks_zzk_TResult);
        }
    }
    ...
    public final void zzb(@android.support.annotation.NonNull com.google.android.gms.tasks.Task<TResult> r3) {
        ...
        r1 = r2.mLock;
        monitor-enter(r1);
        r0 = r2.zzkrq;	 Catch:{ all -> 0x0026 }
        if (r0 == 0) goto L_0x000b;
    L_0x0007:
        r0 = r2.zzkrr;	 Catch:{ all -> 0x0026 }
