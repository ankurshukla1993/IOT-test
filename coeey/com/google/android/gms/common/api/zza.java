...
final class zza implements com.google.android.gms.common.api.PendingResult.zza {
    ...
    L_0x0017:
        r0 = r5.zzfjh;	 Catch:{ all -> 0x0039 }
        r2 = 1;
        r0.zzfjf = true;	 Catch:{ all -> 0x0039 }
    L_0x001d:
        r0 = r5.zzfjh;	 Catch:{ all -> 0x0039 }
        r0.zzfjd = r0.zzfjd - 1;	 Catch:{ all -> 0x0039 }
        r0 = r5.zzfjh;	 Catch:{ all -> 0x0039 }
        r0 = r0.zzfjd;	 Catch:{ all -> 0x0039 }
        if (r0 != 0) goto L_0x0037;
    L_0x002a:
        r0 = r5.zzfjh;	 Catch:{ all -> 0x0039 }
        r0 = r0.zzfjf;	 Catch:{ all -> 0x0039 }
    ...
    L_0x0042:
        r0 = r5.zzfjh;	 Catch:{ all -> 0x0039 }
        r2 = 1;
        r0.zzfje = true;	 Catch:{ all -> 0x0039 }
        goto L_0x001d;
    L_0x0049:
        r0 = r5.zzfjh;	 Catch:{ all -> 0x0039 }
        r0 = r0.zzfje;	 Catch:{ all -> 0x0039 }
    ...
    L_0x0058:
        r2 = r5.zzfjh;	 Catch:{ all -> 0x0039 }
        r3 = new com.google.android.gms.common.api.BatchResult;	 Catch:{ all -> 0x0039 }
        r4 = r5.zzfjh;	 Catch:{ all -> 0x0039 }
        r4 = r4.zzfjg;	 Catch:{ all -> 0x0039 }
        r3.<init>(r0, r4);	 Catch:{ all -> 0x0039 }
        r2.setResult(r3);	 Catch:{ all -> 0x0039 }
        goto L_0x0037;
    L_0x0069:
        r0 = com.google.android.gms.common.api.Status.zzfko;	 Catch:{ all -> 0x0039 }
        goto L_0x0058;
        */
