...
public class GoogleApiAvailability extends zze {
    ...
    class zza extends Handler {
        ...
        public final void handleMessage(Message message) {
            switch (message.what) {
                case 1:
                    int isGooglePlayServicesAvailable = this.zzfic.isGooglePlayServicesAvailable(this.mApplicationContext);
                    if (this.zzfic.isUserResolvableError(isGooglePlayServicesAvailable)) {
                        this.zzfic.showErrorNotification(this.mApplicationContext, isGooglePlayServicesAvailable);
                        return;
                    }
                    return;
                default:
    ...
    @Nullable
    public static zzca zza(Context context, zzcb com_google_android_gms_common_api_internal_zzcb) {
        IntentFilter intentFilter = new IntentFilter("android.intent.action.PACKAGE_ADDED");
        intentFilter.addDataScheme("package");
        BroadcastReceiver com_google_android_gms_common_api_internal_zzca = new zzca(com_google_android_gms_common_api_internal_zzcb);
        context.registerReceiver(com_google_android_gms_common_api_internal_zzca, intentFilter);
        com_google_android_gms_common_api_internal_zzca.setContext(context);
        if (zzo.zzv(context, "com.google.android.gms")) {
            return com_google_android_gms_common_api_internal_zzca;
        }
        com_google_android_gms_common_api_internal_zzcb.zzagu();
        com_google_android_gms_common_api_internal_zzca.unregister();
        return null;
    }
    ...
    public Task<Void> checkApiAvailability(GoogleApi<?> googleApi, GoogleApi<?>... googleApiArr) {
        ...
        return zzbp.zzaie().zza(arrayList);
    }
    ...
    public Dialog getErrorDialog(Activity activity, int i, int i2, OnCancelListener onCancelListener) {
        return zza((Context) activity, i, zzv.zza(activity, zze.zza(activity, i, "d"), i2), onCancelListener);
    }
    ...
    public Task<Void> makeGooglePlayServicesAvailable(Activity activity) {
        zzbq.zzfz("makeGooglePlayServicesAvailable must be called from the main thread");
        int isGooglePlayServicesAvailable = isGooglePlayServicesAvailable(activity);
        if (isGooglePlayServicesAvailable == 0) {
            return Tasks.forResult(null);
        }
        zzo zzp = zzcq.zzp(activity);
    ...
    public final boolean zza(Activity activity, @NonNull zzci com_google_android_gms_common_api_internal_zzci, int i, int i2, OnCancelListener onCancelListener) {
        Dialog zza = zza((Context) activity, i, zzv.zza(com_google_android_gms_common_api_internal_zzci, zze.zza(activity, i, "d"), 2), onCancelListener);
        if (zza == null) {
            return false;
        }
