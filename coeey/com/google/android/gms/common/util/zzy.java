...
public final class zzy {
    ...
    private static String zza(WorkSource workSource, int i) {
        if (zzgcg != null) {
            try {
                return (String) zzgcg.invoke(workSource, new Object[]{Integer.valueOf(i)});
            } catch (Throwable e) {
                Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", e);
            }
        }
    ...
    private static WorkSource zze(int i, String str) {
        ...
        if (zzgcd != null) {
            ...
            try {
                zzgcd.invoke(workSource, new Object[]{Integer.valueOf(i), str});
            } catch (Throwable e) {
                Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", e);
            }
        } else if (zzgcc != null) {
            try {
                zzgcc.invoke(workSource, new Object[]{Integer.valueOf(i)});
            } catch (Throwable e2) {
