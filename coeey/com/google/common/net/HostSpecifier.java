...
public final class HostSpecifier {
    ...
    public static HostSpecifier fromValid(String specifier) {
        ...
        String str = "Domain name does not have a recognized public suffix: ";
    ...
    public static HostSpecifier from(String specifier) throws ParseException {
        try {
            ...
            String str = "Invalid host specifier: ";
            String valueOf = String.valueOf(specifier);
            ParseException parseException = new ParseException(valueOf.length() != 0 ? str.concat(valueOf) : new String(str), 0);
