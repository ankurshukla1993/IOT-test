...
public final class InetAddresses {
    ...
    private static String convertDottedQuadToHex(String ipString) {
        ...
        String valueOf = String.valueOf(String.valueOf(initialPart));
        String valueOf2 = String.valueOf(String.valueOf(penultimate));
        String valueOf3 = String.valueOf(String.valueOf(ultimate));
        return new StringBuilder(((valueOf.length() + 1) + valueOf2.length()) + valueOf3.length()).append(valueOf).append(valueOf2).append(":").append(valueOf3).toString();
    }
    ...
    public static String toUriString(InetAddress ip) {
        ...
        String valueOf = String.valueOf(String.valueOf(toAddrString(ip)));
