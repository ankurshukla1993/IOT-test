...
class MapMakerInternalMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    static final Queue<? extends Object> DISCARDING_QUEUE = new C16572();
    static final int DRAIN_MAX = 16;
    static final int DRAIN_THRESHOLD = 63;
    static final int MAXIMUM_CAPACITY = 1073741824;
    static final int MAX_SEGMENTS = 65536;
    static final ValueReference<Object, Object> UNSET = new C16561();
    ...
    static class C16561 implements ValueReference<Object, Object> {
        C16561() {
        }
    ...
    static class C16572 extends AbstractQueue<Object> {
        C16572() {
        }
    ...
    static final class EvictionQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry<K, V> head = new C16661();

        class C16661 extends AbstractReferenceEntry<K, V> {
    ...
    static final class ExpirationQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry<K, V> head = new C16681();

        class C16681 extends AbstractReferenceEntry<K, V> {
    ...
    void processPendingNotifications() {
        while (true) {
            MapMaker$RemovalNotification<K, V> notification = (MapMaker$RemovalNotification) this.removalNotificationQueue.poll();
