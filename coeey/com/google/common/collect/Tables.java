...
public final class Tables {
    private static final Function<? extends Map<?, ?>, ? extends Map<?, ?>> UNMODIFIABLE_WRAPPER = new C17401();
    ...
    static class C17401 implements Function<Map<Object, Object>, Map<Object, Object>> {
        C17401() {
        }
    ...
    private static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        class C17411 implements Function<Cell<R, C, V1>, Cell<R, C, V2>> {
            C17411() {
            }
        ...
        class C17422 implements Function<Map<C, V1>, Map<C, V2>> {
            C17422() {
            }
        ...
        class C17433 implements Function<Map<R, V1>, Map<R, V2>> {
            C17433() {
            }
        ...
        public Map<R, Map<C, V2>> rowMap() {
            return Maps.transformValues(this.fromTable.rowMap(), new C17422());
        }

        public Map<C, Map<R, V2>> columnMap() {
            return Maps.transformValues(this.fromTable.columnMap(), new C17433());
        }
    }

    private static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        private static final Function<Cell<?, ?, ?>, Cell<?, ?, ?>> TRANSPOSE_CELL = new C17441();
        final Table<R, C, V> original;

        static class C17441 implements Function<Cell<?, ?, ?>, Cell<?, ?, ?>> {
            C17441() {
            }
