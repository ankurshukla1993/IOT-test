...
public final class UnsignedLong extends Number implements Comparable<UnsignedLong>, Serializable {
    ...
    public static UnsignedLong valueOf(long value) {
        ...
        Preconditions.checkArgument(z, "value (%s) is outside the range for an unsigned long value", new Object[]{Long.valueOf(value)});
    ...
    public static UnsignedLong valueOf(BigInteger value) {
        ...
        Preconditions.checkArgument(z, "value (%s) is outside the range for an unsigned long value", new Object[]{value});
