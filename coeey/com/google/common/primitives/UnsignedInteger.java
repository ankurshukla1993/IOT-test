...
public final class UnsignedInteger extends Number implements Comparable<UnsignedInteger> {
    ...
    public static UnsignedInteger valueOf(long value) {
        ...
        Preconditions.checkArgument(z, "value (%s) is outside the range for an unsigned integer value", new Object[]{Long.valueOf(value)});
    ...
    public static UnsignedInteger valueOf(BigInteger value) {
        ...
        Preconditions.checkArgument(z, "value (%s) is outside the range for an unsigned integer value", new Object[]{value});
