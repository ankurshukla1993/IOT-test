...
final class XmlUtils {
    ...
    public static final boolean convertValueToBoolean(CharSequence value, boolean defaultValue) {
        ...
        if (value.equals(AppEventsConstants.EVENT_PARAM_VALUE_YES) || value.equals(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE) || value.equals("TRUE")) {
            result = true;
        }
        return result;
    }
        ...
        try {
            ...
            do {
                if (eventType == 2) {
                    ...
                    if (parser.getName().equals("item") || parser.getName().equals("null")) {
                        i++;
                    } else {
                        throw new XmlPullParserException("Expected " + endTag + " end tag at: " + parser.getName());
                    }
