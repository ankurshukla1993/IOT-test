...
public final class EventTimelineViewHolder extends TimelineItemViewHolder {
    ...
    public void bind(@Nullable TimelineItem currentTimelineItem, @Nullable TimelineItem prevTimelineItem) {
        if (currentTimelineItem != null) {
            ...
            objectRef.element = ActivityStore.getInstance(this.view.getContext()).getActivity(currentTimelineItem.getId());
            if (((Activity) objectRef.element) != null) {
                activity = (Activity) objectRef.element;
                this.activityTitleTextView.setText(activity != null ? activity.getCategory() : null);
            }
            ...
            this.rescheduleTextView.setOnClickListener(new EventTimelineViewHolder$bind$1(this, objectRef));
