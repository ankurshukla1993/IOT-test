...
public class DecisionButtonLayout extends LinearLayout implements OnClickListener {
    ...
    void initialize() {
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0563R.layout.decision_button_layout, this, true);
