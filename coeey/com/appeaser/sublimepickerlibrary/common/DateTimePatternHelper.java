...
public class DateTimePatternHelper {
    ...
    private static String[] loadLocaleInternal(@NonNull Locale locale) {
        if (isLocaleLoaded(locale)) {
            return (String[]) sLoadedDateTimePatterns.get(locale.toString());
        }
        String[] loadedLocalePattern = (String[]) sDateTimePatterns.get(locale.toString());
    ...
    private static void initMap() {
        ...
        sDateTimePatterns.put(ShareConstants.WEB_DIALOG_PARAM_TO, new String[]{"EEE d MMM", "MMMM y", "h:mm a", "HH:mm"});
