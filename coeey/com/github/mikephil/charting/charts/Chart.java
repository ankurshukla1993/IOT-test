...
public abstract class Chart<T extends ChartData<? extends DataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    protected float mDeltaX = FlexItem.FLEX_SHRINK_DEFAULT;
    ...
    class C14921 implements AnimatorUpdateListener {
        C14921() {
        }
    ...
    protected void init() {
        ...
        if (VERSION.SDK_INT < 11) {
            ...
            this.mAnimator = new ChartAnimator(new C14921());
        }
    ...
    public void setDragDecelerationFrictionCoef(float newValue) {
        ...
        if (newValue >= FlexItem.FLEX_SHRINK_DEFAULT) {
            newValue = 0.999f;
        }
    ...
    public void setHighlightEnabled(boolean enabled) {
        if (this.mData != null) {
            this.mData.setHighlightEnabled(enabled);
        }
    }

    public boolean isHighlightEnabled() {
        return this.mData == null ? true : this.mData.isHighlightEnabled();
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (w > 0 && h > 0 && w < AbstractSpiCall.DEFAULT_TIMEOUT && h < AbstractSpiCall.DEFAULT_TIMEOUT) {
