...
public class HorizontalBarChart extends BarChart {
    ...
    public void calculateOffsets() {
        ...
        float xlabelwidth = (float) this.mXAxis.mLabelWidth;
    ...
    protected void calcModulus() {
        ...
        this.mXAxis.mAxisLabelModulus = (int) Math.ceil((double) (((float) (((BarData) this.mData).getXValCount() * this.mXAxis.mLabelHeight)) / (this.mViewPortHandler.contentHeight() * values[4])));
    ...
    public int getLowestVisibleXIndex() {
        ...
        return (int) (f + FlexItem.FLEX_SHRINK_DEFAULT);
    }
