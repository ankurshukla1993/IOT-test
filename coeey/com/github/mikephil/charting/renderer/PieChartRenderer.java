    ...
    protected void drawCenterText(Canvas c) {
        ...
        if (this.mChart.isDrawCenterTextEnabled() && centerText != null) {
            ...
            if (!(centerText.equals(this.mCenterTextLastValue) && boundingRect.equals(this.mCenterTextLastBounds))) {
                ...
                this.mCenterTextLayout = new StaticLayout(centerText, 0, centerText.length(), this.mCenterTextPaint, (int) Math.max(Math.ceil((double) this.mCenterTextLastBounds.width()), 1.0d), Alignment.ALIGN_CENTER, FlexItem.FLEX_SHRINK_DEFAULT, 0.0f, false);
            }
