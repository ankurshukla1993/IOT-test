...
public class MenuPopupHelper implements OnItemClickListener, OnKeyListener, OnGlobalLayoutListener, OnDismissListener, MenuPresenter {
    static final int ITEM_LAYOUT = C0614R.layout.abc_popup_menu_item_layout;
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu) {
        this(context, menu, null, false, C0614R.attr.popupMenuStyle);
    }

    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView) {
        this(context, menu, anchorView, false, C0614R.attr.popupMenuStyle);
    }
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly, int popupStyleAttr, int popupStyleRes) {
        ...
        this.mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0614R.dimen.abc_config_prefDialogWidth));
    ...
    public boolean tryShow() {
        ...
        int vertOffset = (-this.mAnchorView.getHeight()) + Util.dpToPx(4);
        int horizontalOffset = (-this.mContentWidth) + this.mAnchorView.getWidth();
        if (VERSION.SDK_INT < 21) {
            vertOffset = (-this.mAnchorView.getHeight()) - Util.dpToPx(4);
            horizontalOffset = ((-this.mContentWidth) + this.mAnchorView.getWidth()) - Util.dpToPx(8);
        }
        this.mPopup.setVerticalOffset(vertOffset);
