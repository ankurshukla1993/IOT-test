...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    public static final Downsampler AT_LEAST = new C07421();
    public static final Downsampler AT_MOST = new C07432();
    private static final int MARK_POSITION = 5242880;
    public static final Downsampler NONE = new C07443();
    ...
    static class C07421 extends Downsampler {
        C07421() {
        }
    ...
    static class C07432 extends Downsampler {
        C07432() {
        }
    ...
    static class C07443 extends Downsampler {
        C07443() {
        }
