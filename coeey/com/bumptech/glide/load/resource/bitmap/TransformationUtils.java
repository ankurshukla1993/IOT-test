...
public final class TransformationUtils {
    ...
    static void initializeMatrixForRotation(int exifOrientation, Matrix matrix) {
        switch (exifOrientation) {
            case 2:
                matrix.setScale(FlexItem.FLEX_BASIS_PERCENT_DEFAULT, FlexItem.FLEX_SHRINK_DEFAULT);
                return;
            case 3:
            ...
            case 4:
                matrix.setRotate(180.0f);
                matrix.postScale(FlexItem.FLEX_BASIS_PERCENT_DEFAULT, FlexItem.FLEX_SHRINK_DEFAULT);
                return;
            case 5:
