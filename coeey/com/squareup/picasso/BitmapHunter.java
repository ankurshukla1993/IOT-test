...
class BitmapHunter implements Runnable {
    ...
    private static final RequestHandler ERRORING_HANDLER = new C23102();
    private static final ThreadLocal<StringBuilder> NAME_BUILDER = new C23091();
    ...
    static class C23091 extends ThreadLocal<StringBuilder> {
        C23091() {
        }
    ...
    static class C23102 extends RequestHandler {
        C23102() {
        }
