...
public class UrlConnectionDownloader implements Downloader {
    private static final ThreadLocal<StringBuilder> CACHE_HEADER_BUILDER = new C23221();
    ...
    static class C23221 extends ThreadLocal<StringBuilder> {
        C23221() {
        }
    ...
    public Response load(Uri uri, int networkPolicy) throws IOException {
        ...
        if (responseCode >= 300) {
            ...
            throw new ResponseException(responseCode + Constants.SPACE + connection.getResponseMessage(), networkPolicy, responseCode);
        }
