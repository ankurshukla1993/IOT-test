...
public class CrashlyticsCore extends Kit<Void> {
    ...
    public static class Builder {
        private float delay = FlexItem.FLEX_BASIS_PERCENT_DEFAULT;
    ...
    void markInitializationStarted() {
        this.backgroundWorker.submitAndWait(new 2(this));
    }

    void markInitializationComplete() {
        this.backgroundWorker.submit(new 3(this));
    }

    boolean didPreviousInitializationFail() {
        return ((Boolean) this.backgroundWorker.submitAndWait(new 4(this))).booleanValue();
    }
    ...
    private static String formatLogMessage(int priority, String tag, String msg) {
        return CommonUtils.logPriorityToString(priority) + "/" + tag + Constants.SPACE + msg;
    }
