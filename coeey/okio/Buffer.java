...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    ...
    class C25331 extends OutputStream {
        C25331() {
        }
    ...
    class C25342 extends InputStream {
        C25342() {
        }
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if ((b0 & 128) == 0) {
            ...
            byteCount = 1;
            min = 0;
        } else if ((b0 & 224) == JfifUtil.MARKER_SOFn) {
            codePoint = b0 & 31;
            byteCount = 2;
            min = 128;
        } else if ((b0 & 240) == 224) {
        ...
        if (string == null) {
            ...
            while (i < endIndex) {
                ...
                if (c < 128) {
                    ...
                    writeByte((c >> 6) | JfifUtil.MARKER_SOFn);
                    writeByte((c & 63) | 128);
                    i2 = i + 1;
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        if (codePoint < 128) {
            ...
            writeByte((codePoint >> 6) | JfifUtil.MARKER_SOFn);
            writeByte((codePoint & 63) | 128);
    ...
    public Buffer writeDecimalLong(long v) {
        ...
        if (negative) {
            data[pos - 1] = Framer.STDIN_FRAME_PREFIX;
        }
        tail.limit += width;
