...
public class MealTemplateRealmProxy extends MealTemplate implements RealmObjectProxy, MealTemplateRealmProxyInterface {
    private static final List<String> FIELD_NAMES;
    private static final OsObjectSchemaInfo expectedObjectSchemaInfo = createExpectedObjectSchemaInfo();
    private MealTemplateColumnInfo columnInfo;
    private ProxyState<MealTemplate> proxyState;

    static final class MealTemplateColumnInfo extends ColumnInfo {
        long breakFastIndex;
        long dinnerIndex;
        long lunchIndex;

        MealTemplateColumnInfo(OsSchemaInfo schemaInfo) {
            super(3);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("MealTemplate");
        ...
        MealTemplateColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }

        protected final ColumnInfo copy(boolean mutable) {
            return new MealTemplateColumnInfo(this, mutable);
        }

        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            MealTemplateColumnInfo src = (MealTemplateColumnInfo) rawSrc;
            MealTemplateColumnInfo dst = (MealTemplateColumnInfo) rawDst;
    ...
    public void realm$injectObjectContext() {
        if (this.proxyState == null) {
            ...
            this.columnInfo = (MealTemplateColumnInfo) context.getColumnInfo();
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        Builder builder = new Builder("MealTemplate");
    ...
    public static MealTemplateColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new MealTemplateColumnInfo(schemaInfo);
    }

    public static String getTableName() {
        return "class_MealTemplate";
    }
    ...
    public static MealTemplate createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update) throws JSONException {
        ...
        MealTemplate obj = (MealTemplate) realm.createObjectInternal(MealTemplate.class, true, excludeFields);
        MealTemplateRealmProxyInterface objProxy = obj;
        if (json.has("breakFast")) {
    ...
    @TargetApi(11)
    public static MealTemplate createUsingJsonStream(Realm realm, JsonReader reader) throws IOException {
        MealTemplate obj = new MealTemplate();
        MealTemplateRealmProxyInterface objProxy = obj;
        reader.beginObject();
        ...
        reader.endObject();
        return (MealTemplate) realm.copyToRealm(obj);
    }

    public static MealTemplate copyOrUpdate(Realm realm, MealTemplate object, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (MealTemplate) cachedRealmObject;
        }
        return copy(realm, object, update, cache);
    }

    public static MealTemplate copy(Realm realm, MealTemplate newObject, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = (RealmObjectProxy) cache.get(newObject);
        if (cachedRealmObject != null) {
            return (MealTemplate) cachedRealmObject;
        }
        MealTemplate realmObject = (MealTemplate) realm.createObjectInternal(MealTemplate.class, false, Collections.emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);
        MealTemplateRealmProxyInterface realmObjectSource = newObject;
        MealTemplateRealmProxyInterface realmObjectCopy = realmObject;
    ...
    public static long insert(Realm realm, MealTemplate object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(MealTemplate.class);
        long tableNativePtr = table.getNativePtr();
        MealTemplateColumnInfo columnInfo = (MealTemplateColumnInfo) realm.getSchema().getColumnInfo(MealTemplate.class);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel, Long> cache) {
        ...
        while (objects.hasNext()) {
            MealTemplate object = (MealTemplate) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, MealTemplate object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(MealTemplate.class);
    ...
    public static MealTemplate createDetachedCopy(MealTemplate realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        MealTemplate unmanagedObject;
        CacheData<RealmModel> cachedObject = (CacheData) cache.get(realmObject);
        if (cachedObject == null) {
            unmanagedObject = new MealTemplate();
            cache.put(realmObject, new CacheData(currentDepth, unmanagedObject));
        } else if (currentDepth >= cachedObject.minDepth) {
            return (MealTemplate) cachedObject.object;
        } else {
            unmanagedObject = (MealTemplate) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        MealTemplateRealmProxyInterface unmanagedCopy = unmanagedObject;
        MealTemplateRealmProxyInterface realmSource = realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("MealTemplate = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        MealTemplateRealmProxy aMealTemplate = (MealTemplateRealmProxy) o;
        String path = this.proxyState.getRealm$realm().getPath();
        String otherPath = aMealTemplate.proxyState.getRealm$realm().getPath();
        if (path == null ? otherPath != null : !path.equals(otherPath)) {
            return false;
        }
        String tableName = this.proxyState.getRow$realm().getTable().getName();
        String otherTableName = aMealTemplate.proxyState.getRow$realm().getTable().getName();
        if (tableName == null ? otherTableName != null : !tableName.equals(otherTableName)) {
            return false;
        }
        if (this.proxyState.getRow$realm().getIndex() != aMealTemplate.proxyState.getRow$realm().getIndex()) {
            return false;
        }
        return true;
    }
