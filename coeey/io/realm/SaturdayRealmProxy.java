...
public class SaturdayRealmProxy extends Saturday implements RealmObjectProxy, SaturdayRealmProxyInterface {
    private static final List<String> FIELD_NAMES;
    private static final OsObjectSchemaInfo expectedObjectSchemaInfo = createExpectedObjectSchemaInfo();
    private SaturdayColumnInfo columnInfo;
    private ProxyState<Saturday> proxyState;

    static final class SaturdayColumnInfo extends ColumnInfo {
        long breakFastIndex;
        long dinnerIndex;
        long lunchIndex;

        SaturdayColumnInfo(OsSchemaInfo schemaInfo) {
            super(3);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("Saturday");
        ...
        SaturdayColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }

        protected final ColumnInfo copy(boolean mutable) {
            return new SaturdayColumnInfo(this, mutable);
        }

        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            SaturdayColumnInfo src = (SaturdayColumnInfo) rawSrc;
            SaturdayColumnInfo dst = (SaturdayColumnInfo) rawDst;
    ...
    public void realm$injectObjectContext() {
        if (this.proxyState == null) {
            ...
            this.columnInfo = (SaturdayColumnInfo) context.getColumnInfo();
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        Builder builder = new Builder("Saturday");
    ...
    public static SaturdayColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new SaturdayColumnInfo(schemaInfo);
    }

    public static String getTableName() {
        return "class_Saturday";
    }
    ...
    public static Saturday createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update) throws JSONException {
        ...
        Saturday obj = (Saturday) realm.createObjectInternal(Saturday.class, true, excludeFields);
        SaturdayRealmProxyInterface objProxy = obj;
        if (json.has("breakFast")) {
    ...
    @TargetApi(11)
    public static Saturday createUsingJsonStream(Realm realm, JsonReader reader) throws IOException {
        ...
        reader.endObject();
        return (Saturday) realm.copyToRealm(obj);
    }

    public static Saturday copyOrUpdate(Realm realm, Saturday object, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (Saturday) cachedRealmObject;
        }
        return copy(realm, object, update, cache);
    }

    public static Saturday copy(Realm realm, Saturday newObject, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = (RealmObjectProxy) cache.get(newObject);
        if (cachedRealmObject != null) {
            return (Saturday) cachedRealmObject;
        }
        Saturday realmObject = (Saturday) realm.createObjectInternal(Saturday.class, false, Collections.emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);
        SaturdayRealmProxyInterface realmObjectSource = newObject;
        SaturdayRealmProxyInterface realmObjectCopy = realmObject;
    ...
    public static long insert(Realm realm, Saturday object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(Saturday.class);
        long tableNativePtr = table.getNativePtr();
        SaturdayColumnInfo columnInfo = (SaturdayColumnInfo) realm.getSchema().getColumnInfo(Saturday.class);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel, Long> cache) {
        ...
        while (objects.hasNext()) {
            Saturday object = (Saturday) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, Saturday object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(Saturday.class);
    ...
    public static Saturday createDetachedCopy(Saturday realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        Saturday unmanagedObject;
        CacheData<RealmModel> cachedObject = (CacheData) cache.get(realmObject);
        if (cachedObject == null) {
            unmanagedObject = new Saturday();
            cache.put(realmObject, new CacheData(currentDepth, unmanagedObject));
        } else if (currentDepth >= cachedObject.minDepth) {
            return (Saturday) cachedObject.object;
        } else {
            unmanagedObject = (Saturday) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        SaturdayRealmProxyInterface unmanagedCopy = unmanagedObject;
        SaturdayRealmProxyInterface realmSource = realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("Saturday = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        SaturdayRealmProxy aSaturday = (SaturdayRealmProxy) o;
        String path = this.proxyState.getRealm$realm().getPath();
        String otherPath = aSaturday.proxyState.getRealm$realm().getPath();
        if (path == null ? otherPath != null : !path.equals(otherPath)) {
            return false;
        }
        String tableName = this.proxyState.getRow$realm().getTable().getName();
        String otherTableName = aSaturday.proxyState.getRow$realm().getTable().getName();
        if (tableName == null ? otherTableName != null : !tableName.equals(otherTableName)) {
            return false;
        }
        if (this.proxyState.getRow$realm().getIndex() != aSaturday.proxyState.getRow$realm().getIndex()) {
            return false;
        }
        return true;
    }
