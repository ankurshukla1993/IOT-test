...
public class FridayRealmProxy extends Friday implements RealmObjectProxy, FridayRealmProxyInterface {
    private static final List<String> FIELD_NAMES;
    private static final OsObjectSchemaInfo expectedObjectSchemaInfo = createExpectedObjectSchemaInfo();
    private FridayColumnInfo columnInfo;
    private ProxyState<Friday> proxyState;

    static final class FridayColumnInfo extends ColumnInfo {
        long breakFastIndex;
        long dinnerIndex;
        long lunchIndex;

        FridayColumnInfo(OsSchemaInfo schemaInfo) {
            super(3);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("Friday");
        ...
        FridayColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }

        protected final ColumnInfo copy(boolean mutable) {
            return new FridayColumnInfo(this, mutable);
        }

        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            FridayColumnInfo src = (FridayColumnInfo) rawSrc;
            FridayColumnInfo dst = (FridayColumnInfo) rawDst;
    ...
    public void realm$injectObjectContext() {
        if (this.proxyState == null) {
            ...
            this.columnInfo = (FridayColumnInfo) context.getColumnInfo();
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        Builder builder = new Builder("Friday");
    ...
    public static FridayColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new FridayColumnInfo(schemaInfo);
    }
    ...
    public static Friday createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update) throws JSONException {
        ...
        Friday obj = (Friday) realm.createObjectInternal(Friday.class, true, excludeFields);
        FridayRealmProxyInterface objProxy = obj;
        if (json.has("breakFast")) {
    ...
    @TargetApi(11)
    public static Friday createUsingJsonStream(Realm realm, JsonReader reader) throws IOException {
        Friday obj = new Friday();
        FridayRealmProxyInterface objProxy = obj;
        reader.beginObject();
        ...
        reader.endObject();
        return (Friday) realm.copyToRealm(obj);
    }

    public static Friday copyOrUpdate(Realm realm, Friday object, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (Friday) cachedRealmObject;
        }
        return copy(realm, object, update, cache);
    }

    public static Friday copy(Realm realm, Friday newObject, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = (RealmObjectProxy) cache.get(newObject);
        if (cachedRealmObject != null) {
            return (Friday) cachedRealmObject;
        }
        Friday realmObject = (Friday) realm.createObjectInternal(Friday.class, false, Collections.emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);
        FridayRealmProxyInterface realmObjectSource = newObject;
        FridayRealmProxyInterface realmObjectCopy = realmObject;
    ...
    public static long insert(Realm realm, Friday object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(Friday.class);
        long tableNativePtr = table.getNativePtr();
        FridayColumnInfo columnInfo = (FridayColumnInfo) realm.getSchema().getColumnInfo(Friday.class);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel, Long> cache) {
        ...
        while (objects.hasNext()) {
            Friday object = (Friday) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, Friday object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(Friday.class);
    ...
    public static Friday createDetachedCopy(Friday realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        Friday unmanagedObject;
        CacheData<RealmModel> cachedObject = (CacheData) cache.get(realmObject);
        if (cachedObject == null) {
            unmanagedObject = new Friday();
            cache.put(realmObject, new CacheData(currentDepth, unmanagedObject));
        } else if (currentDepth >= cachedObject.minDepth) {
            return (Friday) cachedObject.object;
        } else {
            unmanagedObject = (Friday) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        FridayRealmProxyInterface unmanagedCopy = unmanagedObject;
        FridayRealmProxyInterface realmSource = realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("Friday = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        FridayRealmProxy aFriday = (FridayRealmProxy) o;
        String path = this.proxyState.getRealm$realm().getPath();
        String otherPath = aFriday.proxyState.getRealm$realm().getPath();
        if (path == null ? otherPath != null : !path.equals(otherPath)) {
            return false;
        }
        String tableName = this.proxyState.getRow$realm().getTable().getName();
        String otherTableName = aFriday.proxyState.getRow$realm().getTable().getName();
        if (tableName == null ? otherTableName != null : !tableName.equals(otherTableName)) {
            return false;
        }
        if (this.proxyState.getRow$realm().getIndex() != aFriday.proxyState.getRow$realm().getIndex()) {
            return false;
        }
        return true;
    }
