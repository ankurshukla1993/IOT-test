...
public class WednesdayRealmProxy extends Wednesday implements RealmObjectProxy, WednesdayRealmProxyInterface {
    ...
    static final class WednesdayColumnInfo extends ColumnInfo {
        long breakFastIndex;
        long dinnerIndex;
        long lunchIndex;

        WednesdayColumnInfo(OsSchemaInfo schemaInfo) {
            super(3);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("Wednesday");
        ...
        WednesdayColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }

        protected final ColumnInfo copy(boolean mutable) {
            return new WednesdayColumnInfo(this, mutable);
        }

        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            WednesdayColumnInfo src = (WednesdayColumnInfo) rawSrc;
            WednesdayColumnInfo dst = (WednesdayColumnInfo) rawDst;
    ...
    public void realm$injectObjectContext() {
        if (this.proxyState == null) {
            ...
            this.columnInfo = (WednesdayColumnInfo) context.getColumnInfo();
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        Builder builder = new Builder("Wednesday");
    ...
    public static WednesdayColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new WednesdayColumnInfo(schemaInfo);
    }
    ...
    public static Wednesday createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update) throws JSONException {
        ...
        Wednesday obj = (Wednesday) realm.createObjectInternal(Wednesday.class, true, excludeFields);
        WednesdayRealmProxyInterface objProxy = obj;
        if (json.has("breakFast")) {
    ...
    @TargetApi(11)
    public static Wednesday createUsingJsonStream(Realm realm, JsonReader reader) throws IOException {
        ...
        reader.endObject();
        return (Wednesday) realm.copyToRealm(obj);
    }

    public static Wednesday copyOrUpdate(Realm realm, Wednesday object, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (Wednesday) cachedRealmObject;
        }
        return copy(realm, object, update, cache);
    }

    public static Wednesday copy(Realm realm, Wednesday newObject, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = (RealmObjectProxy) cache.get(newObject);
        if (cachedRealmObject != null) {
            return (Wednesday) cachedRealmObject;
        }
        Wednesday realmObject = (Wednesday) realm.createObjectInternal(Wednesday.class, false, Collections.emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);
        WednesdayRealmProxyInterface realmObjectSource = newObject;
        WednesdayRealmProxyInterface realmObjectCopy = realmObject;
    ...
    public static long insert(Realm realm, Wednesday object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(Wednesday.class);
        long tableNativePtr = table.getNativePtr();
        WednesdayColumnInfo columnInfo = (WednesdayColumnInfo) realm.getSchema().getColumnInfo(Wednesday.class);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel, Long> cache) {
        ...
        while (objects.hasNext()) {
            Wednesday object = (Wednesday) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, Wednesday object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(Wednesday.class);
    ...
    public static Wednesday createDetachedCopy(Wednesday realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        Wednesday unmanagedObject;
        CacheData<RealmModel> cachedObject = (CacheData) cache.get(realmObject);
        if (cachedObject == null) {
            unmanagedObject = new Wednesday();
            cache.put(realmObject, new CacheData(currentDepth, unmanagedObject));
        } else if (currentDepth >= cachedObject.minDepth) {
            return (Wednesday) cachedObject.object;
        } else {
            unmanagedObject = (Wednesday) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        WednesdayRealmProxyInterface unmanagedCopy = unmanagedObject;
        WednesdayRealmProxyInterface realmSource = realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("Wednesday = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        WednesdayRealmProxy aWednesday = (WednesdayRealmProxy) o;
        String path = this.proxyState.getRealm$realm().getPath();
        String otherPath = aWednesday.proxyState.getRealm$realm().getPath();
        if (path == null ? otherPath != null : !path.equals(otherPath)) {
            return false;
        }
        String tableName = this.proxyState.getRow$realm().getTable().getName();
        String otherTableName = aWednesday.proxyState.getRow$realm().getTable().getName();
        if (tableName == null ? otherTableName != null : !tableName.equals(otherTableName)) {
            return false;
        }
        if (this.proxyState.getRow$realm().getIndex() != aWednesday.proxyState.getRow$realm().getIndex()) {
            return false;
        }
        return true;
    }
