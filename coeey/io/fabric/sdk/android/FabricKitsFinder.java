...
class FabricKitsFinder implements Callable<Map<String, KitInfo>> {
    ...
    public Map<String, KitInfo> call() throws Exception {
        ...
        Fabric.getLogger().mo5790v(Fabric.TAG, "finish scanning in " + (SystemClock.elapsedRealtime() - startScan));
        return kitInfos;
    }
    ...
    private Map<String, KitInfo> findImplicitKits() {
        ...
        try {
            ...
            Fabric.getLogger().mo5790v(Fabric.TAG, "Found kit: com.google.firebase.firebase-ads");
        } catch (Exception e) {
        }
        return implicitKits;
    }
        ...
        while (entries.hasMoreElements()) {
            ...
            if (entry.getName().startsWith(FABRIC_DIR) && entry.getName().length() > FABRIC_DIR.length()) {
                ...
                if (kitInfo != null) {
                    ...
                    Fabric.getLogger().mo5790v(Fabric.TAG, String.format("Found kit:[%s] version:[%s]", new Object[]{kitInfo.getIdentifier(), kitInfo.getVersion()}));
                }
            }
        }
        if (apkFile != null) {
    ...
    private KitInfo loadKitInfo(ZipEntry fabricFile, ZipFile apk) {
        ...
        try {
            ...
            kitInfo.mo5782e(Fabric.TAG, "Error when parsing fabric properties " + fabricFile.getName(), ie);
            return null;
        } finally {
