...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory threadFactory = new C23901();
    ...
    private final WorkerRunnable<Params, Result> worker = new C23912();

    static class C23901 implements ThreadFactory {
    ...
    class C23912 extends WorkerRunnable<Params, Result> {
        C23912() {
            super();
        }
