...
public class InstallerPackageNameProvider {
    ...
    private final ValueLoader<String> installerPackageNameLoader = new C23871();

    class C23871 implements ValueLoader<String> {
        C23871() {
        }
    ...
    public String getInstallerPackageName(Context appContext) {
        try {
            ...
            Fabric.getLogger().mo5782e(Fabric.TAG, "Failed to determine installer package name", e);
            return null;
        }
    }
}
