...
*/
    ...
    public static RunningAppProcessInfo getAppProcessInfo(String packageName, Context context) {
        List<RunningAppProcessInfo> processes = ((ActivityManager) context.getSystemService(AmProfile.SYNC_ACTIVITY_DATA_AM)).getRunningAppProcesses();
        if (processes == null) {
            return null;
        }
    ...
    public static long calculateFreeRamInBytes(Context context) {
        ...
        ((ActivityManager) context.getSystemService(AmProfile.SYNC_ACTIVITY_DATA_AM)).getMemoryInfo(mi);
        return mi.availMem;
    }
