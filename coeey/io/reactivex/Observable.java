...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public final T blockingFirst() {
        Observer s = new BlockingFirstObserver();
        subscribe(s);
        T v = s.blockingGet();
        if (v != null) {
            return v;
    ...
    public final T blockingLast() {
        Observer s = new BlockingLastObserver();
        subscribe(s);
        T v = s.blockingGet();
        if (v != null) {
            return v;
    ...
    public final <U extends Collection<? super T>> Observable<U> buffer(int count, int skip, Callable<U> bufferSupplier) {
        ObjectHelper.verifyPositive(count, Bg5Profile.HISTORICAL_NUM_BG);
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy strategy) {
        ...
        switch (1.$SwitchMap$io$reactivex$BackpressureStrategy[strategy.ordinal()]) {
            case 1:
