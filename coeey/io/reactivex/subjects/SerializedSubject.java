...
final class SerializedSubject<T> extends Subject<T> implements NonThrowingPredicate<Object> {
    ...
    L_0x0015:
        ...
        r2 = r3.emitting;	 Catch:{ all -> 0x0031 }
        if (r2 == 0) goto L_0x0034;
    L_0x001c:
        r0 = r3.queue;	 Catch:{ all -> 0x0031 }
    ...
    L_0x0028:
        r2 = io.reactivex.internal.util.NotificationLite.error(r4);	 Catch:{ all -> 0x0031 }
