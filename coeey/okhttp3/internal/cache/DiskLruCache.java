...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private static final Sink NULL_SINK = new C25024();
    private static final String READ = "READ";
    private static final String REMOVE = "REMOVE";
    static final String VERSION_1 = "1";
    private final int appVersion;
    private final Runnable cleanupRunnable = new C24991();
    ...
    class C25013 implements Iterator<Snapshot> {
    ...
    static class C25024 implements Sink {
        C25024() {
        }
    ...
    private void readJournalLine(String line) throws IOException {
        ...
        if (secondSpace != -1 && firstSpace == CLEAN.length() && line.startsWith(CLEAN)) {
            String[] parts = line.substring(secondSpace + 1).split(Constants.SPACE);
            entry.readable = true;
