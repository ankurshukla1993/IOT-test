...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    public interface Logger {
        public static final Logger DEFAULT = new C25291();

        class C25291 implements Logger {
            C25291() {
            }
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        String requestStartMessage = "--> " + request.method() + ' ' + request.url() + (connection != null ? Constants.SPACE + connection.protocol() : "");
    ...
    private boolean bodyEncoded(Headers headers) {
        ...
        return (contentEncoding == null || contentEncoding.equalsIgnoreCase(InterpolationAnimatedNode.EXTRAPOLATE_TYPE_IDENTITY)) ? false : true;
    }
}
