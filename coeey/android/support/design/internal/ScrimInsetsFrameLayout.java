...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C00921 implements OnApplyWindowInsetsListener {
        C00921() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0086R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0086R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0086R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00921());
    }
