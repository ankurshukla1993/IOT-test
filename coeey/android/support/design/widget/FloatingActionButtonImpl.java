...
class FloatingActionButtonImpl {
    ...
    class C01243 implements OnPreDrawListener {
        C01243() {
        }
    ...
    void show(@Nullable final InternalVisibilityChangedListener listener, final boolean fromUser) {
        if (!isOrWillBeShown()) {
            ...
            if (shouldAnimateVisibilityChange()) {
                ...
                this.mView.animate().scaleX(FlexItem.FLEX_SHRINK_DEFAULT).scaleY(FlexItem.FLEX_SHRINK_DEFAULT).alpha(FlexItem.FLEX_SHRINK_DEFAULT).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new AnimatorListenerAdapter() {
                    public void onAnimationStart(Animator animation) {
                        FloatingActionButtonImpl.this.mView.internalSetVisibility(0, fromUser);
                    }
            ...
            this.mView.setAlpha(FlexItem.FLEX_SHRINK_DEFAULT);
            this.mView.setScaleY(FlexItem.FLEX_SHRINK_DEFAULT);
            this.mView.setScaleX(FlexItem.FLEX_SHRINK_DEFAULT);
            if (listener != null) {
                listener.onShown();
            }
        }
    ...
    CircularBorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C0086R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0086R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0086R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0086R.color.design_fab_stroke_end_outer_color));
    ...
    private void ensurePreDrawListener() {
        if (this.mPreDrawListener == null) {
            this.mPreDrawListener = new C01243();
        }
    }
