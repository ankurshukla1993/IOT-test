...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    static final Handler sHandler = new Handler(Looper.getMainLooper(), new C00971());
    private final AccessibilityManager mAccessibilityManager;
    private List<BaseCallback<B>> mCallbacks;
    private final ContentViewCallback mContentViewCallback;
    private final Context mContext;
    private int mDuration;
    final Callback mManagerCallback = new C00993();
    ...
    static class C00971 implements Callback {
        C00971() {
        }
    ...
    class C00982 implements OnApplyWindowInsetsListener {
        C00982() {
        }
    ...
    class C00993 implements Callback {
        C00993() {
        }
    ...
    class C01004 implements OnDismissListener {
        C01004() {
        }
    ...
    class C01025 implements OnAttachStateChangeListener {
        ...
        public void onViewDetachedFromWindow(View v) {
            if (BaseTransientBottomBar.this.isShownOrQueued()) {
                BaseTransientBottomBar.sHandler.post(new C01011());
            }
        }
    }
    ...
    class C01036 implements OnLayoutChangeListener {
        C01036() {
        }
    ...
    class C01047 extends AnimatorListenerAdapter {
        C01047() {
        }
    ...
    class C01069 implements AnimationListener {
        C01069() {
        }
    ...
    static class SnackbarBaseLayout extends FrameLayout {
        ...
        SnackbarBaseLayout(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0086R.styleable.SnackbarLayout);
            if (a.hasValue(C0086R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0086R.styleable.SnackbarLayout_elevation, 0));
            }
            a.recycle();
            setClickable(true);
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            this.mView = (SnackbarBaseLayout) LayoutInflater.from(this.mContext).inflate(C0086R.layout.design_layout_snackbar, this.mTargetParent, false);
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C00982());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C01004());
                clp.setBehavior(behavior);
                clp.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C01025());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C01036());
    ...
    void animateViewIn() {
        if (VERSION.SDK_INT >= 12) {
            ...
            animator.addListener(new C01047());
        ...
        Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0086R.anim.design_snackbar_in);
        anim.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        anim.setDuration(250);
        anim.setAnimationListener(new C01069());
    ...
    private void animateViewOut(final int event) {
        ...
        Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0086R.anim.design_snackbar_out);
        anim.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        anim.setDuration(250);
