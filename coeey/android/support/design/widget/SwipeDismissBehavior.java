...
public class SwipeDismissBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback mDragCallback = new C01301();
    ...
    class C01301 extends Callback {
        ...
        public void onViewPositionChanged(View child, int left, int top, int dx, int dy) {
            ...
            if (((float) left) <= startAlphaDistance) {
                child.setAlpha(FlexItem.FLEX_SHRINK_DEFAULT);
            } else if (((float) left) >= endAlphaDistance) {
                child.setAlpha(0.0f);
            } else {
                child.setAlpha(SwipeDismissBehavior.clamp(0.0f, FlexItem.FLEX_SHRINK_DEFAULT - SwipeDismissBehavior.fraction(startAlphaDistance, endAlphaDistance, (float) left), (float) FlexItem.FLEX_SHRINK_DEFAULT));
            }
        }
    }
    ...
    public void setDragDismissDistance(float distance) {
        this.mDragDismissThreshold = clamp(0.0f, distance, (float) FlexItem.FLEX_SHRINK_DEFAULT);
    }

    public void setStartAlphaSwipeDistance(float fraction) {
        this.mAlphaStartSwipeDistance = clamp(0.0f, fraction, (float) FlexItem.FLEX_SHRINK_DEFAULT);
    }

    public void setEndAlphaSwipeDistance(float fraction) {
        this.mAlphaEndSwipeDistance = clamp(0.0f, fraction, (float) FlexItem.FLEX_SHRINK_DEFAULT);
    }
