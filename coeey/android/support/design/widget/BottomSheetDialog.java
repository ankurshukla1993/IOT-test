...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C01132 extends AccessibilityDelegateCompat {
        C01132() {
        }
    ...
    class C01143 implements OnTouchListener {
        C01143() {
        }
    ...
    class C01154 extends BottomSheetCallback {
        C01154() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C01154();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0086R.layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0086R.id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0086R.id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0086R.id.touch_outside).setOnClickListener(new C01121());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C01132());
        bottomSheet.setOnTouchListener(new C01143());
        return container;
    }
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C0086R.attr.bottomSheetDialogTheme, outValue, true)) {
            return outValue.resourceId;
        }
        return C0086R.style.Theme_Design_Light_BottomSheetDialog;
    }
}
