...
public class Guideline extends ConstraintWidget {
    ...
    protected float mRelativePercent = FlexItem.FLEX_BASIS_PERCENT_DEFAULT;
    ...
    public int getRelativeBehaviour() {
        if (this.mRelativePercent != FlexItem.FLEX_BASIS_PERCENT_DEFAULT) {
            return 0;
        }
    ...
    public void setGuidePercent(float value) {
        if (value > FlexItem.FLEX_BASIS_PERCENT_DEFAULT) {
    ...
    public void setGuideBegin(int value) {
        if (value > -1) {
            this.mRelativePercent = FlexItem.FLEX_BASIS_PERCENT_DEFAULT;
    ...
    public void addToSolver(LinearSystem system, int group) {
        ...
        if (parent != null) {
            ...
            } else if (this.mRelativePercent != FlexItem.FLEX_BASIS_PERCENT_DEFAULT) {
