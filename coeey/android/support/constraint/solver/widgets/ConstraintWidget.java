...
public class ConstraintWidget {
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + Constants.SPACE : "") + (this.mDebugName != null ? "id: " + this.mDebugName + Constants.SPACE : "") + "(" + this.mX + ", " + this.mY + ") - (" + this.mWidth + " x " + this.mHeight + ")" + " wrap: (" + this.mWrapWidth + " x " + this.mWrapHeight + ")";
    }
            ...
            if (this.mHorizontalDimensionBehaviour == DimensionBehaviour.MATCH_CONSTRAINT && this.mVerticalDimensionBehaviour == DimensionBehaviour.MATCH_CONSTRAINT) {
                ...
                if (horizontalDimensionFixed && !verticalDimensionFixed) {
                    ...
                    if (this.mDimensionRatioSide == -1) {
                        dimensionRatio = FlexItem.FLEX_SHRINK_DEFAULT / dimensionRatio;
                    }
                }
