...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new C03911();

    static class C03911 implements Comparator<Snake> {
        C03911() {
        }
                ...
                for (int i = count - 1; i >= 0; i--) {
                    ...
                    switch (status) {
                        ...
                        case 16:
                            ...
                            break;
                        default:
                            throw new IllegalStateException("unknown flag for pos " + (globalIndex + i) + Constants.SPACE + Long.toBinaryString((long) status));
                    }
                }
                return;
            }
