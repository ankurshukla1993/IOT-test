...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C04503 implements OnItemSelectedListener {
        C04503() {
        }
    ...
    public ListPopupWindow(@NonNull Context context) {
        this(context, null, C0385R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0385R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0385R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0385R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0385R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C04492();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C04503());
            ...
            if (hintView != null) {
                ...
                hintParams = new LayoutParams(-1, 0, FlexItem.FLEX_SHRINK_DEFAULT);
