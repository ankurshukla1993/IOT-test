...
class FastScroller extends ItemDecoration implements OnItemTouchListener {
    ...
    private final Runnable mHideRunnable = new C04341();
    @VisibleForTesting
    ...
    private final OnScrollListener mOnScrollListener = new C04352();
    private RecyclerView mRecyclerView;
    private int mRecyclerViewHeight = 0;
    private int mRecyclerViewWidth = 0;
    private final int mScrollbarMinimumRange;
    private final ValueAnimator mShowHideAnimator = ValueAnimator.ofFloat(new float[]{0.0f, FlexItem.FLEX_SHRINK_DEFAULT});
    ...
    class C04352 extends OnScrollListener {
        C04352() {
        }
    ...
    public void show() {
        ...
        this.mShowHideAnimator.setFloatValues(new float[]{((Float) this.mShowHideAnimator.getAnimatedValue()).floatValue(), FlexItem.FLEX_SHRINK_DEFAULT});
    ...
    private void drawVerticalScrollbar(Canvas canvas) {
        ...
        if (isLayoutRTL()) {
            ...
            canvas.scale(FlexItem.FLEX_SHRINK_DEFAULT, FlexItem.FLEX_SHRINK_DEFAULT);
            canvas.translate((float) (-this.mVerticalThumbWidth), (float) (-top));
            return;
        }
