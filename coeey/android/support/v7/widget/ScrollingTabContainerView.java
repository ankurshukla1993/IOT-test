...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat {
        ...
        public TabView(Context context, Tab tab, boolean forList) {
            super(context, null, C0385R.attr.actionBarTabStyle);
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0385R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView = new AppCompatTextView(getContext(), null, C0385R.attr.actionBarTabTextStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), null, C0385R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner spinner = new AppCompatSpinner(getContext(), null, C0385R.attr.actionDropDownStyle);
    ...
    public void animateToVisibility(int visibility) {
        ...
        if (visibility == 0) {
            ...
            ViewPropertyAnimator anim = animate().alpha(FlexItem.FLEX_SHRINK_DEFAULT);
    ...
    public void addTab(Tab tab, boolean setSelected) {
        ...
        this.mTabLayout.addView(tabView, new LayoutParams(0, -1, FlexItem.FLEX_SHRINK_DEFAULT));
        if (this.mTabSpinner != null) {
    ...
    public void addTab(Tab tab, int position, boolean setSelected) {
        TabView tabView = createTabView(tab, false);
        this.mTabLayout.addView(tabView, position, new LayoutParams(0, -1, FlexItem.FLEX_SHRINK_DEFAULT));
        if (this.mTabSpinner != null) {
            ((TabAdapter) this.mTabSpinner.getAdapter()).notifyDataSetChanged();
        }
        if (setSelected) {
