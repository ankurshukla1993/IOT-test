...
import android.support.v7.gridlayout.C0387R;
...
public class GridLayout extends ViewGroup {
    private static final int ALIGNMENT_MODE = C0387R.styleable.GridLayout_alignmentMode;
    public static final int ALIGN_BOUNDS = 0;
    public static final int ALIGN_MARGINS = 1;
    public static final Alignment BASELINE = new C04447();
    public static final Alignment BOTTOM = TRAILING;
    private static final int CAN_STRETCH = 2;
    public static final Alignment CENTER = new C04426();
    private static final int COLUMN_COUNT = C0387R.styleable.GridLayout_columnCount;
    private static final int COLUMN_ORDER_PRESERVED = C0387R.styleable.GridLayout_columnOrderPreserved;
    ...
    public static final Alignment FILL = new C04458();
    public static final int HORIZONTAL = 0;
    private static final int INFLEXIBLE = 0;
    private static final Alignment LEADING = new C04393();
    ...
    static final Printer NO_PRINTER = new C04371();
    private static final int ORIENTATION = C0387R.styleable.GridLayout_orientation;
    public static final Alignment RIGHT = createSwitchingAlignment(END, START);
    private static final int ROW_COUNT = C0387R.styleable.GridLayout_rowCount;
    private static final int ROW_ORDER_PRESERVED = C0387R.styleable.GridLayout_rowOrderPreserved;
    public static final Alignment START = LEADING;
    public static final Alignment TOP = LEADING;
    private static final Alignment TRAILING = new C04404();
    public static final int UNDEFINED = Integer.MIN_VALUE;
    static final Alignment UNDEFINED_ALIGNMENT = new C04382();
    static final int UNINITIALIZED_HASH = 0;
    private static final int USE_DEFAULT_MARGINS = C0387R.styleable.GridLayout_useDefaultMargins;
    ...
    static class C04371 implements Printer {
        C04371() {
        }
    ...
    static class C04382 extends Alignment {
        C04382() {
        }
    ...
    static class C04393 extends Alignment {
        C04393() {
        }
    ...
    static class C04404 extends Alignment {
        C04404() {
        }
    ...
    static class C04426 extends Alignment {
        C04426() {
        }
    ...
    static class C04447 extends Alignment {

        class C04431 extends Bounds {
            private int size;
    ...
    static class C04458 extends Alignment {
        C04458() {
        }
    ...
    static final class Arc {
        ...
        public String toString() {
            return this.span + Constants.SPACE + (!this.valid ? "+>" : "->") + Constants.SPACE + this.value;
        }
    }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        private static final int BOTTOM_MARGIN = C0387R.styleable.GridLayout_Layout_android_layout_marginBottom;
        private static final int COLUMN = C0387R.styleable.GridLayout_Layout_layout_column;
        private static final int COLUMN_SPAN = C0387R.styleable.GridLayout_Layout_layout_columnSpan;
        private static final int COLUMN_WEIGHT = C0387R.styleable.GridLayout_Layout_layout_columnWeight;
        ...
        private static final int GRAVITY = C0387R.styleable.GridLayout_Layout_layout_gravity;
        private static final int LEFT_MARGIN = C0387R.styleable.GridLayout_Layout_android_layout_marginLeft;
        private static final int MARGIN = C0387R.styleable.GridLayout_Layout_android_layout_margin;
        private static final int RIGHT_MARGIN = C0387R.styleable.GridLayout_Layout_android_layout_marginRight;
        private static final int ROW = C0387R.styleable.GridLayout_Layout_layout_row;
        private static final int ROW_SPAN = C0387R.styleable.GridLayout_Layout_layout_rowSpan;
        private static final int ROW_WEIGHT = C0387R.styleable.GridLayout_Layout_layout_rowWeight;
        private static final int TOP_MARGIN = C0387R.styleable.GridLayout_Layout_android_layout_marginTop;
        ...
        private void reInitSuper(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0387R.styleable.GridLayout_Layout);
            try {
    ...
    public GridLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C0387R.dimen.default_gap);
        TypedArray a = context.obtainStyledAttributes(attrs, C0387R.styleable.GridLayout);
        try {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (c.getVisibility() != 8) {
                ...
                if (!(width == c.getMeasuredWidth() && height == c.getMeasuredHeight())) {
                    c.measure(MeasureSpec.makeMeasureSpec(width, Ints.MAX_POWER_OF_TWO), MeasureSpec.makeMeasureSpec(height, Ints.MAX_POWER_OF_TWO));
                }
