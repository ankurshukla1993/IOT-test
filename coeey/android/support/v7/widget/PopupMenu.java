...
public class PopupMenu {
    ...
    class C04541 implements Callback {
        C04541() {
        }
    ...
    class C04552 implements android.widget.PopupWindow.OnDismissListener {
        C04552() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0385R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C04541());
        ...
        this.mPopup.setOnDismissListener(new C04552());
    }
