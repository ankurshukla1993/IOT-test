...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new C04801();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C04811();
            int mGapDir;
            int[] mGapPerSpan;
            boolean mHasUnwantedGapAfter;
            int mPosition;

            static class C04811 implements Creator<FullSpanItem> {
                C04811() {
                }
            ...
            for (i = 0; i < childCount; i++) {
                ...
                if (size >= maxSize) {
                    if (((LayoutParams) child.getLayoutParams()).isFullSpan()) {
                        size = (FlexItem.FLEX_SHRINK_DEFAULT * size) / ((float) this.mSpanCount);
                    }
