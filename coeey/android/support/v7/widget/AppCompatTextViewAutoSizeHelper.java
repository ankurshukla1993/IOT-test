...
*/
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(attrs, C0385R.styleable.AppCompatTextView, defStyleAttr, 0);
        if (a.hasValue(C0385R.styleable.AppCompatTextView_autoSizeTextType)) {
            this.mAutoSizeTextType = a.getInt(C0385R.styleable.AppCompatTextView_autoSizeTextType, 0);
        }
        if (a.hasValue(C0385R.styleable.AppCompatTextView_autoSizeStepGranularity)) {
            autoSizeStepGranularityInPx = a.getDimension(C0385R.styleable.AppCompatTextView_autoSizeStepGranularity, -1.0f);
        }
        if (a.hasValue(C0385R.styleable.AppCompatTextView_autoSizeMinTextSize)) {
            autoSizeMinTextSizeInPx = a.getDimension(C0385R.styleable.AppCompatTextView_autoSizeMinTextSize, -1.0f);
        }
        if (a.hasValue(C0385R.styleable.AppCompatTextView_autoSizeMaxTextSize)) {
            autoSizeMaxTextSizeInPx = a.getDimension(C0385R.styleable.AppCompatTextView_autoSizeMaxTextSize, -1.0f);
        }
        if (a.hasValue(C0385R.styleable.AppCompatTextView_autoSizePresetSizes)) {
            int autoSizeStepSizeArrayResId = a.getResourceId(C0385R.styleable.AppCompatTextView_autoSizePresetSizes, 0);
        ...
        if (!supportsAutoSizeText()) {
            ...
            if (!this.mHasPresetAutoSizeValues) {
                ...
                if (autoSizeStepGranularityInPx == -1.0f) {
                    autoSizeStepGranularityInPx = FlexItem.FLEX_SHRINK_DEFAULT;
                }
    ...
    void setAutoSizeTextTypeWithDefaults(int autoSizeTextType) {
        if (supportsAutoSizeText()) {
            switch (autoSizeTextType) {
                ...
                case 1:
                    DisplayMetrics displayMetrics = this.mContext.getResources().getDisplayMetrics();
                    validateAndSetAutoSizeTextTypeUniformConfiguration(TypedValue.applyDimension(2, 12.0f, displayMetrics), TypedValue.applyDimension(2, 112.0f, displayMetrics), FlexItem.FLEX_SHRINK_DEFAULT);
    ...
    private StaticLayout createStaticLayoutForMeasuringPre23(CharSequence text, Alignment alignment, int availableWidth) {
        ...
        if (VERSION.SDK_INT >= 16) {
            ...
            lineSpacingMultiplier = ((Float) invokeAndReturnWithDefault(this.mTextView, "getLineSpacingMultiplier", Float.valueOf(FlexItem.FLEX_SHRINK_DEFAULT))).floatValue();
