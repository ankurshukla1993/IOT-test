...
import android.support.v7.recyclerview.C0388R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C04593();
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C04631();
        ...
        private final Callback mVerticalBoundCheckCallback = new C04642();
        private int mWidth;
        ...
        class C04642 implements Callback {
            C04642() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0388R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0388R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0388R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0388R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0388R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    static class C04593 implements Interpolator {
        C04593() {
        }

        public float getInterpolation(float t) {
            t -= FlexItem.FLEX_SHRINK_DEFAULT;
            return ((((t * t) * t) * t) * t) + FlexItem.FLEX_SHRINK_DEFAULT;
        }
    }

    class C04604 implements ProcessCallback {
        C04604() {
        }
    ...
    class C04615 implements Callback {
        C04615() {
        }
    ...
    class C04626 implements Callback {
        C04626() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C04651();
        Parcelable mLayoutState;

        static class C04651 implements ClassLoaderCreator<SavedState> {
            C04651() {
            }
    ...
    class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int dx, int dy, int vx, int vy) {
            ...
            float distance = ((float) halfContainerSize) + (((float) halfContainerSize) * distanceInfluenceForSnapDuration(Math.min(FlexItem.FLEX_SHRINK_DEFAULT, (FlexItem.FLEX_SHRINK_DEFAULT * ((float) delta)) / ((float) containerSize))));
            if (velocity > 0) {
                ...
                duration = (int) (((((float) absDx) / ((float) containerSize)) + FlexItem.FLEX_SHRINK_DEFAULT) * 300.0f);
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C04571();
        ...
        this.mItemAnimatorRunner = new C04582();
        this.mViewInfoProcessCallback = new C04604();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0388R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0388R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0388R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a.getBoolean(C0388R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a.getDrawable(C0388R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C0388R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C0388R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C0388R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a.recycle();
    ...
    String exceptionLabel() {
        return Constants.SPACE + super.toString() + ", adapter:" + this.mAdapter + ", layout:" + this.mLayout + ", context:" + getContext();
    }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C04615());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C04626());
    }
    ...
    private void pullGlows(float x, float overscrollX, float y, float overscrollY) {
        ...
        if (overscrollX < 0.0f) {
            ensureLeftGlow();
            EdgeEffectCompat.onPull(this.mLeftGlow, (-overscrollX) / ((float) getWidth()), FlexItem.FLEX_SHRINK_DEFAULT - (y / ((float) getHeight())));
            invalidate = true;
        ...
        if (overscrollY < 0.0f) {
            ...
            ensureBottomGlow();
            EdgeEffectCompat.onPull(this.mBottomGlow, overscrollY / ((float) getHeight()), FlexItem.FLEX_SHRINK_DEFAULT - (x / ((float) getWidth())));
            invalidate = true;
        }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        FastScroller fastScroller = new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0388R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0388R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0388R.dimen.fastscroll_margin));
    }
