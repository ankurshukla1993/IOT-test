...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0385R.attr.actionBarSize, 16842841};
    ...
    class C04081 extends AnimatorListenerAdapter {
        C04081() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C04081();
        this.mRemoveActionBarHideOffset = new C04092();
        this.mAddActionBarHideOffset = new C04103();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0385R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0385R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0385R.id.action_bar));
        }
    }
