...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                view.setAlpha(FlexItem.FLEX_SHRINK_DEFAULT);
    ...
    void animateAddImpl(final ViewHolder holder) {
        ...
        animation.alpha(FlexItem.FLEX_SHRINK_DEFAULT).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(FlexItem.FLEX_SHRINK_DEFAULT).setListener(new AnimatorListenerAdapter() {
                public void onAnimationStart(Animator animator) {
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    newView.setAlpha(FlexItem.FLEX_SHRINK_DEFAULT);
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, ViewHolder item) {
        ...
        item.itemView.setAlpha(FlexItem.FLEX_SHRINK_DEFAULT);
    ...
    public void endAnimations() {
        ...
        for (i = this.mPendingAdditions.size() - 1; i >= 0; i--) {
            ...
            item2.itemView.setAlpha(FlexItem.FLEX_SHRINK_DEFAULT);
