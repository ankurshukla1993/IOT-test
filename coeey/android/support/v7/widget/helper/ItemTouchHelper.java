...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C04942();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C04931();
    ...
    class C04942 implements OnItemTouchListener {
        C04942() {
        }
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator = ValueAnimator.ofFloat(new float[]{0.0f, FlexItem.FLEX_SHRINK_DEFAULT});
            this.mValueAnimator.addUpdateListener(new C05001());
        ...
        public void onAnimationCancel(Animator animation) {
            setFraction(FlexItem.FLEX_SHRINK_DEFAULT);
        }
    ...
    class C04975 implements ChildDrawingOrderCallback {
        C04975() {
        }
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C04981();
        private static final Interpolator sDragViewScrollCapInterpolator = new C04992();
        ...
        static class C04992 implements Interpolator {
            C04992() {
            }
        ...
        public int interpolateOutOfBoundsScroll(RecyclerView recyclerView, int viewSize, int viewSizeOutOfBounds, int totalSize, long msSinceStartScroll) {
            float timeRatio;
            int cappedScroll = (int) (((float) (((int) Math.signum((float) viewSizeOutOfBounds)) * getMaxDragScroll(recyclerView))) * sDragViewScrollCapInterpolator.getInterpolation(Math.min(FlexItem.FLEX_SHRINK_DEFAULT, (FlexItem.FLEX_SHRINK_DEFAULT * ((float) Math.abs(viewSizeOutOfBounds))) / ((float) viewSize))));
            if (msSinceStartScroll > DRAG_SCROLL_ACCELERATION_LIMIT_TIME_MS) {
                timeRatio = FlexItem.FLEX_SHRINK_DEFAULT;
            } else {
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C04975();
            }
