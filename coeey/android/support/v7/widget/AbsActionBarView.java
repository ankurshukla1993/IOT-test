...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0385R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0385R.styleable.ActionBar, C0385R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0385R.styleable.ActionBar_height, 0));
        a.recycle();
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int visibility, long duration) {
        ...
        if (visibility == 0) {
            ...
            ViewPropertyAnimatorCompat anim = ViewCompat.animate(this).alpha(FlexItem.FLEX_SHRINK_DEFAULT);
