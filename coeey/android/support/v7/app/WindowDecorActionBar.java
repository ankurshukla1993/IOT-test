...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C03821();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C03832();
    ...
    class C03821 extends ViewPropertyAnimatorListenerAdapter {
        C03821() {
        }
    ...
    class C03832 extends ViewPropertyAnimatorListenerAdapter {
        C03832() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0385R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0385R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0385R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0385R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0385R.styleable.ActionBar, C0385R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0385R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0385R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public void doShow(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || fromSystem)) {
            ...
            this.mContainerView.setAlpha(FlexItem.FLEX_SHRINK_DEFAULT);
            this.mContainerView.setTranslationY(0.0f);
            if (this.mContentAnimations && this.mContentView != null) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0385R.attr.actionBarWidgetTheme, outValue, true);
