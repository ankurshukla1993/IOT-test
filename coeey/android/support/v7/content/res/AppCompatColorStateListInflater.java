    ...
    private static ColorStateList inflate(@NonNull Resources r, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (depth < innerDepth && type == 3) {
                ...
                TypedArray a = obtainAttributes(r, theme, attrs, C0385R.styleable.ColorStateListItem);
                int baseColor = a.getColor(C0385R.styleable.ColorStateListItem_android_color, -65281);
                float alphaMod = FlexItem.FLEX_SHRINK_DEFAULT;
                if (a.hasValue(C0385R.styleable.ColorStateListItem_android_alpha)) {
                    alphaMod = a.getFloat(C0385R.styleable.ColorStateListItem_android_alpha, FlexItem.FLEX_SHRINK_DEFAULT);
                } else if (a.hasValue(C0385R.styleable.ColorStateListItem_alpha)) {
                    alphaMod = a.getFloat(C0385R.styleable.ColorStateListItem_alpha, FlexItem.FLEX_SHRINK_DEFAULT);
                }
                a.recycle();
                ...
                while (i < numAttrs) {
                    ...
                    if (stateResId == 16843173 || stateResId == 16843551 || stateResId == C0385R.attr.alpha) {
                        j2 = j;
                    } else {
                        j2 = j + 1;
