...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C03491 implements AnimationListener {
        C03491() {
        }
    ...
    class C03502 extends Animation {
        C03502() {
        }
    ...
    class C03513 extends Animation {
        C03513() {
        }

        public void applyTransformation(float interpolatedTime, Transformation t) {
            SwipeRefreshLayout.this.setAnimationProgress(FlexItem.FLEX_SHRINK_DEFAULT - interpolatedTime);
        }
    }

    class C03535 implements AnimationListener {
        C03535() {
        }
    ...
    class C03546 extends Animation {
        C03546() {
        }
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            SwipeRefreshLayout.this.mProgress.setArrowScale(FlexItem.FLEX_SHRINK_DEFAULT - interpolatedTime);
        }
    }

    class C03557 extends Animation {
        C03557() {
        }
    ...
    class C03568 extends Animation {
        C03568() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mRefreshing = false;
        this.mTotalDragDistance = FlexItem.FLEX_BASIS_PERCENT_DEFAULT;
        this.mParentScrollConsumed = new int[2];
        this.mParentOffsetInWindow = new int[2];
        this.mActivePointerId = -1;
        this.mCircleViewIndex = -1;
        this.mRefreshListener = new C03491();
        this.mAnimateToCorrectPosition = new C03546();
        this.mAnimateToStartPosition = new C03557();
        ...
        moveToStart(FlexItem.FLEX_SHRINK_DEFAULT);
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C03502();
    ...
    void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C03513();
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        float dragPercent = Math.min(FlexItem.FLEX_SHRINK_DEFAULT, Math.abs(overscrollTop / this.mTotalDragDistance));
        ...
        if (!this.mScale) {
            this.mCircleView.setScaleX(FlexItem.FLEX_SHRINK_DEFAULT);
            this.mCircleView.setScaleY(FlexItem.FLEX_SHRINK_DEFAULT);
        }
        if (this.mScale) {
            setAnimationProgress(Math.min(FlexItem.FLEX_SHRINK_DEFAULT, overscrollTop / this.mTotalDragDistance));
        }
        ...
        this.mProgress.setArrowScale(Math.min(FlexItem.FLEX_SHRINK_DEFAULT, adjustedPercent));
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C03568();
