...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild2, ScrollingView {
    ...
    static class SavedState extends BaseSavedState {
        ...
        static class C03451 implements Creator<SavedState> {
            C03451() {
            }
                        ...
                        if (!dispatchNestedScroll(0, scrolledDeltaY, 0, deltaY - scrolledDeltaY, this.mScrollOffset, 0)) {
                            if (canOverscroll) {
                                ...
                                if (pulledToY < 0) {
                                    ...
                                    EdgeEffectCompat.onPull(this.mEdgeGlowBottom, ((float) deltaY) / ((float) getHeight()), FlexItem.FLEX_SHRINK_DEFAULT - (ev.getX(activePointerIndex) / ((float) getWidth())));
