...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        float mArrowScale = FlexItem.FLEX_SHRINK_DEFAULT;
        int mArrowWidth;
    ...
    private void applyTransformation(float interpolatedTime, Ring ring, boolean lastFrame) {
        if (this.mFinishing) {
        ...
        } else if (interpolatedTime != FlexItem.FLEX_SHRINK_DEFAULT || lastFrame) {
            float startTrim;
            float endTrim;
            ...
            if (interpolatedTime < SHRINK_OFFSET) {
                ...
                startTrim = endTrim - (((FlexItem.FLEX_SHRINK_DEFAULT - MATERIAL_INTERPOLATOR.getInterpolation((interpolatedTime - SHRINK_OFFSET) / SHRINK_OFFSET)) * 0.79f) + MIN_PROGRESS_ARC);
            }
    ...
    private void setupAnimators() {
        ...
        ValueAnimator animator = ValueAnimator.ofFloat(new float[]{0.0f, FlexItem.FLEX_SHRINK_DEFAULT});
        ...
        animator.addListener(new AnimatorListener() {
            ...
            public void onAnimationRepeat(Animator animator) {
                CircularProgressDrawable.this.applyTransformation(FlexItem.FLEX_SHRINK_DEFAULT, ring, true);
                ring.storeOriginals();
                ring.goToNextColor();
                ...
                CircularProgressDrawable.this.mRotationCount = CircularProgressDrawable.this.mRotationCount + FlexItem.FLEX_SHRINK_DEFAULT;
            }
        });
