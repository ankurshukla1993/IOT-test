...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C02231();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C02242();
    ...
    class C02242 extends WorkerRunnable<Params, Result> {
        C02242() {
        }
