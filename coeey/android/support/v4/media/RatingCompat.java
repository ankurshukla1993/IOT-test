...
public final class RatingCompat implements Parcelable {
    ...
    public static RatingCompat newHeartRating(boolean hasHeart) {
        return new RatingCompat(1, hasHeart ? FlexItem.FLEX_SHRINK_DEFAULT : 0.0f);
    }

    public static RatingCompat newThumbRating(boolean thumbIsUp) {
        return new RatingCompat(2, thumbIsUp ? FlexItem.FLEX_SHRINK_DEFAULT : 0.0f);
    }
    ...
    public boolean hasHeart() {
        ...
        if (this.mRatingValue != FlexItem.FLEX_SHRINK_DEFAULT) {
            z = false;
        }
        return z;
    }
    ...
    public boolean isThumbUp() {
        if (this.mRatingStyle == 2 && this.mRatingValue == FlexItem.FLEX_SHRINK_DEFAULT) {
            return true;
        }
        return false;
    }
