...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C02791();
        VolumeProviderCompat mVolumeProvider;
        int mVolumeType;

        class C02791 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02791() {
            }
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        class C02771 implements OnPlaybackPositionUpdateListener {
            C02771() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setPlaybackPositionUpdateListener(new C02771());
        }
        ...
        void setRccState(PlaybackStateCompat state) {
            ...
            if (state.getState() == 3 && position > 0) {
                ...
                if (updateTime > 0) {
                    ...
                    if (speed > 0.0f && speed != FlexItem.FLEX_SHRINK_DEFAULT) {
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        class C02781 implements OnMetadataUpdateListener {
            C02781() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setMetadataUpdateListener(new C02781());
        }
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C02801();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C02801 implements Creator<QueueItem> {
            C02801() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C02811();
        private ResultReceiver mResultReceiver;

        static class C02811 implements Creator<ResultReceiverWrapper> {
            C02811() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C02821();
        private final IMediaSession mExtraBinder;
        private final Object mInner;

        static class C02821 implements Creator<Token> {
            C02821() {
            }
