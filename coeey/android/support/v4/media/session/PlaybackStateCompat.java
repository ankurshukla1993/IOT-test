...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C02841();
    ...
    static class C02841 implements Creator<PlaybackStateCompat> {
        C02841() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C02851();
        ...
        static class C02851 implements Creator<CustomAction> {
            C02851() {
            }
