...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attrs) {
        ...
        this.mFullUnderlineHeight = (int) ((FlexItem.FLEX_SHRINK_DEFAULT * density) + 0.5f);
        ...
        this.mPrevText.setOnClickListener(new C03221());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C03232());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mDrawFullUnderline) {
            this.mTabPaint.setColor(ViewCompat.MEASURED_STATE_MASK | (this.mIndicatorColor & 16777215));
