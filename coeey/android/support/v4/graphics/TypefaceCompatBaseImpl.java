...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C02291 implements StyleExtractor<FontInfo> {
        C02291() {
        }
    ...
    class C02302 implements StyleExtractor<FontFileResourceEntry> {
        C02302() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C02291());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C02302());
    }
