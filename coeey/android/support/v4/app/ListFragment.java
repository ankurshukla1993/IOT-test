...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C02182();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C02171();
    ...
    class C02182 implements OnItemClickListener {
        C02182() {
        }
