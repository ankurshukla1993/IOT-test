...
final class FragmentManagerImpl extends FragmentManager implements Factory2 {
    ...
    int mCurState = 0;
    boolean mDestroyed;
    Runnable mExecCommit = new C01961();
...
*/
    ...
    AnimationOrAnimator loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case 1:
                return makeOpenCloseAnimation(this.mHost.getContext(), 1.125f, FlexItem.FLEX_SHRINK_DEFAULT, 0.0f, FlexItem.FLEX_SHRINK_DEFAULT);
            case 2:
                return makeOpenCloseAnimation(this.mHost.getContext(), FlexItem.FLEX_SHRINK_DEFAULT, 0.975f, FlexItem.FLEX_SHRINK_DEFAULT, 0.0f);
            case 3:
                return makeOpenCloseAnimation(this.mHost.getContext(), 0.975f, FlexItem.FLEX_SHRINK_DEFAULT, 0.0f, FlexItem.FLEX_SHRINK_DEFAULT);
            case 4:
                return makeOpenCloseAnimation(this.mHost.getContext(), FlexItem.FLEX_SHRINK_DEFAULT, 1.075f, FlexItem.FLEX_SHRINK_DEFAULT, 0.0f);
            case 5:
                return makeFadeAnimation(this.mHost.getContext(), 0.0f, FlexItem.FLEX_SHRINK_DEFAULT);
            case 6:
                return makeFadeAnimation(this.mHost.getContext(), FlexItem.FLEX_SHRINK_DEFAULT, 0.0f);
            default:
            ...
            for (int i = 0; i < numActive; i++) {
                ...
                if (fragment != null && fragment.mView != null && fragment.mIsNewlyAdded && record.interactsWith(fragment.mContainerId)) {
                    ...
                    if (moveToState) {
                        ...
                        fragment.mPostponedAlpha = FlexItem.FLEX_BASIS_PERCENT_DEFAULT;
