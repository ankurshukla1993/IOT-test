...
public class Fade extends Visibility {
    ...
    private static class FadeAnimatorListener extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animation) {
            ViewUtils.setTransitionAlpha(this.mView, FlexItem.FLEX_SHRINK_DEFAULT);
    ...
    public Animator onAppear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (startAlpha == FlexItem.FLEX_SHRINK_DEFAULT) {
            startAlpha = 0.0f;
        }
        return createAnimation(view, startAlpha, FlexItem.FLEX_SHRINK_DEFAULT);
    }

    public Animator onDisappear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ViewUtils.saveNonTransitionAlpha(view);
        return createAnimation(view, getStartAlpha(startValues, FlexItem.FLEX_SHRINK_DEFAULT), 0.0f);
    }
