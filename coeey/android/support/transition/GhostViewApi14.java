...
class GhostViewApi14 extends View implements GhostViewImpl {
    ...
    private final OnPreDrawListener mOnPreDrawListener = new C01671();
    int mReferences;
    ViewGroup mStartParent;
    View mStartView;
    final View mView;

    class C01671 implements OnPreDrawListener {
        C01671() {
        }
    ...
    private static void setGhostView(@NonNull View view, GhostViewApi14 ghostView) {
        view.setTag(C0171R.id.ghost_view, ghostView);
    }

    static GhostViewApi14 getGhostView(@NonNull View view) {
        return (GhostViewApi14) view.getTag(C0171R.id.ghost_view);
    }
}
