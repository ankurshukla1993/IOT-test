...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator<Matrix> NULL_MATRIX_EVALUATOR = new C01601();
    ...
    static class C01601 implements TypeEvaluator<Matrix> {
        C01601() {
        }
    ...
    private static Matrix copyImageMatrix(ImageView view) {
        switch (C01623.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
            case 1:
