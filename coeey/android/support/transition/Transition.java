...
public abstract class Transition implements Cloneable {
    ...
    private static final PathMotion STRAIGHT_PATH_MOTION = new C01781();
    ...
    static class C01781 extends PathMotion {
        C01781() {
        }
    ...
    class C01803 extends AnimatorListenerAdapter {
        C01803() {
        }
    ...
    protected void animate(Animator animator) {
        ...
        animator.addListener(new C01803());
        animator.start();
    }
