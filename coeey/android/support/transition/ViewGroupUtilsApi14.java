...
class ViewGroupUtilsApi14 implements ViewGroupUtilsImpl {
    ...
    class C01841 extends LayoutTransition {
        C01841() {
        }
    ...
    public void suppressLayout(@NonNull ViewGroup group, boolean suppress) {
        if (sEmptyLayoutTransition == null) {
            sEmptyLayoutTransition = new C01841();
        ...
        if (suppress) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    group.setTag(C0171R.id.transition_layout_save, layoutTransition);
                }
            }
        ...
        layoutTransition = (LayoutTransition) group.getTag(C0171R.id.transition_layout_save);
        if (layoutTransition != null) {
            group.setTag(C0171R.id.transition_layout_save, null);
