...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VFullPath extends VPath {
        float mFillAlpha = FlexItem.FLEX_SHRINK_DEFAULT;
        int mFillColor = 0;
        int mFillRule = 0;
        float mStrokeAlpha = FlexItem.FLEX_SHRINK_DEFAULT;
        int mStrokeColor = 0;
        ...
        float mTrimPathEnd = FlexItem.FLEX_SHRINK_DEFAULT;
    ...
    private static class VPathRenderer {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int w, int h, ColorFilter filter) {
            ...
            if (matrixScale != 0.0f) {
                ...
                if (!(fullPath.mTrimPathStart == 0.0f && fullPath.mTrimPathEnd == FlexItem.FLEX_SHRINK_DEFAULT)) {
                    float start = (fullPath.mTrimPathStart + fullPath.mTrimPathOffset) % FlexItem.FLEX_SHRINK_DEFAULT;
                    float end = (fullPath.mTrimPathEnd + fullPath.mTrimPathOffset) % FlexItem.FLEX_SHRINK_DEFAULT;
        ...
        private float getMatrixScale(Matrix groupStackedMatrix) {
            float[] unitVectors = new float[]{0.0f, FlexItem.FLEX_SHRINK_DEFAULT, FlexItem.FLEX_SHRINK_DEFAULT, 0.0f};
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mTmpBounds.width() > 0 && this.mTmpBounds.height() > 0) {
            ...
            if (!(canvasSkewX == 0.0f && canvasSkewY == 0.0f)) {
                canvasScaleX = FlexItem.FLEX_SHRINK_DEFAULT;
                canvasScaleY = FlexItem.FLEX_SHRINK_DEFAULT;
            }
