...
public class ListChangeRegistry extends CallbackRegistry<OnListChangedCallback, ObservableList, ListChanges> {
    ...
    private static final NotifierCallback<OnListChangedCallback, ObservableList, ListChanges> NOTIFIER_CALLBACK = new C00381();
    private static final int REMOVED = 4;
    private static final SynchronizedPool<ListChanges> sListChanges = new SynchronizedPool(10);

    static class C00381 extends NotifierCallback<OnListChangedCallback, ObservableList, ListChanges> {
        C00381() {
        }
