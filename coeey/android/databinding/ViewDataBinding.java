...
import com.android.databinding.library.C0561R;
...
public abstract class ViewDataBinding extends BaseObservable {
    ...
    private static final CreateWeakListener CREATE_LIST_LISTENER = new C00512();
    private static final CreateWeakListener CREATE_MAP_LISTENER = new C00523();
    private static final CreateWeakListener CREATE_PROPERTY_LISTENER = new C00501();
    private static final int HALTED = 2;
    private static final int REBIND = 1;
    private static final NotifierCallback<OnRebindCallback, ViewDataBinding, Void> REBIND_NOTIFIER = new C00534();
    ...
    private final Runnable mRebindRunnable = new C00556();
    ...
    static class C00501 implements CreateWeakListener {
        C00501() {
        }
    ...
    static class C00512 implements CreateWeakListener {
        C00512() {
        }
    ...
    static class C00523 implements CreateWeakListener {
        C00523() {
        }
    ...
    static class C00534 extends NotifierCallback<OnRebindCallback, ViewDataBinding, Void> {
        C00534() {
        }
    ...
    static class C00545 implements OnAttachStateChangeListener {
        C00545() {
        }
    ...
    class C00556 implements Runnable {
        C00556() {
        }
    ...
    class C00567 implements FrameCallback {
        C00567() {
        }
    ...
    static {
        ...
        if (VERSION.SDK_INT < 19) {
            ...
            ROOT_REATTACHED_LISTENER = new C00545();
        }
    }
    ...
    protected ViewDataBinding(DataBindingComponent bindingComponent, View root, int localFieldCount) {
        ...
        if (Looper.myLooper() == null) {
            ...
            this.mFrameCallback = new C00567();
        } else {
    ...
    protected void setRootTag(View view) {
        if (USE_TAG_ID) {
            view.setTag(C0561R.id.dataBinding, this);
        } else {
            view.setTag(this);
        }
    }
    ...
    protected void setRootTag(View[] views) {
        ...
        if (USE_TAG_ID) {
            length = views.length;
            while (i < length) {
                views[i].setTag(C0561R.id.dataBinding, this);
                i++;
            }
            return;
        }
    ...
    static ViewDataBinding getBinding(View v) {
        if (v != null) {
            if (USE_TAG_ID) {
                return (ViewDataBinding) v.getTag(C0561R.id.dataBinding);
            }
            Object tag = v.getTag();
