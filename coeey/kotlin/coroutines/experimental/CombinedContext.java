...
public final class CombinedContext implements CoroutineContext {
    ...
    public CombinedContext(@NotNull CoroutineContext left, @NotNull Element element) {
        Intrinsics.checkParameterIsNotNull(left, ViewProps.LEFT);
