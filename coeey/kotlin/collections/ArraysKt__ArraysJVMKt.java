...
class ArraysKt__ArraysJVMKt {
    ...
    private static final <T> T[] toTypedArray(@NotNull Collection<? extends T> $receiver) {
        ...
        Intrinsics.reifiedOperationMarker(0, "T?");
        T[] toArray = thisCollection.toArray(new Object[size]);
        if (toArray != null) {
            return toArray;
        }
