...
public class SimpleTimeFormat implements TimeFormat {
    ...
    public String decorate(Duration duration, String time) {
        ...
        if (duration.isInPast()) {
            result.append(this.pastPrefix).append(Constants.SPACE).append(time).append(Constants.SPACE).append(this.pastSuffix);
        } else {
            result.append(this.futurePrefix).append(Constants.SPACE).append(time).append(Constants.SPACE).append(this.futureSuffix);
        }
