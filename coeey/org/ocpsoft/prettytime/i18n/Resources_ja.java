...
public class Resources_ja extends ListResourceBundle implements TimeFormatProvider {
    ...
    private static class JaTimeFormat implements TimeFormat {
        ...
        public String decorate(Duration duration, String time) {
            ...
            return result.toString().replaceAll("\\s+", Constants.SPACE).trim();
        }
    ...
    static {
        ...
        r0[2] = new Object[]{"CenturyFutureSuffix", "世紀にもわたっ"};
        r0[3] = new Object[]{"CenturyPastPrefix", ""};
        r0[4] = new Object[]{"CenturyPastSuffix", "世紀前"};
        r0[5] = new Object[]{"CenturySingularName", ""};
        r0[6] = new Object[]{"CenturyPluralName", ""};
        r0[7] = new Object[]{"DayPattern", "%n%u"};
        r0[8] = new Object[]{"DayFuturePrefix", "今から"};
        r0[9] = new Object[]{"DayFutureSuffix", "間"};
        ...
        r0[16] = new Object[]{"DecadeFutureSuffix", "年間"};
        r0[17] = new Object[]{"DecadePastPrefix", ""};
        r0[18] = new Object[]{"DecadePastSuffix", "年前"};
        r0[19] = new Object[]{"DecadeSingularName", ""};
        r0[20] = new Object[]{"DecadePluralName", ""};
        ...
        r0[30] = new Object[]{"JustNowFutureSuffix", "今からすぐ"};
        r0[31] = new Object[]{"JustNowPastPrefix", ""};
        r0[32] = new Object[]{"JustNowPastSuffix", "さっき"};
        ...
        r0[37] = new Object[]{"MillenniumFutureSuffix", "今から"};
        ...
        r0[44] = new Object[]{"MillisecondFutureSuffix", "今から"};
        ...
        r0[72] = new Object[]{"WeekFutureSuffix", "週間"};
        r0[73] = new Object[]{"WeekPastPrefix", ""};
        r0[74] = new Object[]{"WeekPastSuffix", "週間前"};
        r0[75] = new Object[]{"WeekSingularName", ""};
        r0[76] = new Object[]{"WeekPluralName", ""};
        r0[77] = new Object[]{"YearPattern", "%n%u"};
        r0[78] = new Object[]{"YearFuturePrefix", ""};
        r0[79] = new Object[]{"YearFutureSuffix", "年後の"};
        r0[80] = new Object[]{"YearPastPrefix", ""};
        r0[81] = new Object[]{"YearPastSuffix", "年前"};
        r0[82] = new Object[]{"YearSingularName", ""};
        r0[83] = new Object[]{"YearPluralName", ""};
