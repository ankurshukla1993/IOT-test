        ...
        if (properties != null) {
            ...
            while (e.hasMoreElements()) {
                ...
                if (!this.cmd.hasOption(option)) {
                    ...
                    } else if (!("yes".equalsIgnoreCase(value) || ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equalsIgnoreCase(value) || AppEventsConstants.EVENT_PARAM_VALUE_YES.equalsIgnoreCase(value))) {
                        return;
                    }
