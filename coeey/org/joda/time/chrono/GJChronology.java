...
public final class GJChronology extends AssembledChronology {
    ...
    public static GJChronology getInstance(DateTimeZone dateTimeZone, ReadableInstant readableInstant, int i) {
        ...
        if (readableInstant == null) {
            readableInstant2 = DEFAULT_CUTOVER;
        } else {
        ...
        GJCacheKey gJCacheKey = new GJCacheKey(zone, readableInstant2, i);
        ...
        if (zone == DateTimeZone.UTC) {
            gJChronology2 = new GJChronology(JulianChronology.getInstance(zone, i), GregorianChronology.getInstance(zone, i), readableInstant2);
        } else {
        ...
        gJChronology = (GJChronology) cCache.putIfAbsent(gJCacheKey, gJChronology2);
        if (gJChronology != null) {
            return gJChronology;
        }
    ...
    protected void assemble(Fields fields) {
        ...
        if (getBase() == null) {
            ...
            fields.monthOfYear = new ImpreciseCutoverField(this, julianChronology.monthOfYear(), fields.monthOfYear, null, fields.years, this.iCutoverMillis);
