            ...
            if (durationFieldTypeArr != null) {
                if (durationFieldTypeArr.length != 0) {
                    ...
                    if (obj instanceof PeriodType) {
                        ...
                        List arrayList = new ArrayList(Arrays.asList(durationFieldTypeArr));
                        ...
                        periodType2 = new PeriodType(null, standard.iTypes, null);
                        periodType = (PeriodType) map.get(periodType2);
                        if (periodType != null) {
                            map.put(periodType2, periodType);
                        } else {
