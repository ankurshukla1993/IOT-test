...
public abstract class AbstractInterval implements ReadableInterval {
    ...
    public boolean overlaps(ReadableInterval readableInterval) {
        ...
        currentTimeMillis = readableInterval.getStartMillis();
        if (startMillis >= readableInterval.getEndMillis() || currentTimeMillis >= endMillis) {
            return false;
        }
        return true;
    }
    ...
    public boolean isAfter(ReadableInterval readableInterval) {
        ...
        if (readableInterval == null) {
            ...
            currentTimeMillis = readableInterval.getEndMillis();
        }
        return getStartMillis() >= currentTimeMillis;
    }
