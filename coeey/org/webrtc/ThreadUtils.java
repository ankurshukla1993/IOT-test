        ...
        handler.post(new Runnable() {
            public void run() {
                try {
                    ...
                    caughtException.f2822e = e;
                }
                barrier.countDown();
            }
        });
        awaitUninterruptibly(barrier);
        if (caughtException.f2822e == null) {
            return result.value;
        }
        RuntimeException runtimeException = new RuntimeException(caughtException.f2822e);
        runtimeException.setStackTrace(concatStackTraces(caughtException.f2822e.getStackTrace(), runtimeException.getStackTrace()));
