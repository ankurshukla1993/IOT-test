...
public class GlShader {
    ...
    private static int compileShader(int shaderType, String source) {
        ...
        if (compileStatus[0] != 1) {
            Logging.m2188e(TAG, "Could not compile shader " + shaderType + ":" + GLES20.glGetShaderInfoLog(shader));
    ...
    public GlShader(String vertexSource, String fragmentSource) {
        ...
        if (linkStatus[0] != 1) {
            Logging.m2188e(TAG, "Could not link program: " + GLES20.glGetProgramInfoLog(this.program));
    ...
    public void release() {
        Logging.m2187d(TAG, "Deleting shader.");
        if (this.program != -1) {
