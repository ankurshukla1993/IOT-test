...
public class GlRectDrawer implements GlDrawer {
    private static final FloatBuffer FULL_RECTANGLE_BUF = GlUtil.createFloatBuffer(new float[]{FlexItem.FLEX_BASIS_PERCENT_DEFAULT, FlexItem.FLEX_BASIS_PERCENT_DEFAULT, FlexItem.FLEX_SHRINK_DEFAULT, FlexItem.FLEX_BASIS_PERCENT_DEFAULT, FlexItem.FLEX_BASIS_PERCENT_DEFAULT, FlexItem.FLEX_SHRINK_DEFAULT, FlexItem.FLEX_SHRINK_DEFAULT, FlexItem.FLEX_SHRINK_DEFAULT});
    private static final FloatBuffer FULL_RECTANGLE_TEX_BUF = GlUtil.createFloatBuffer(new float[]{0.0f, 0.0f, FlexItem.FLEX_SHRINK_DEFAULT, 0.0f, 0.0f, FlexItem.FLEX_SHRINK_DEFAULT, FlexItem.FLEX_SHRINK_DEFAULT, FlexItem.FLEX_SHRINK_DEFAULT});
